...
CREATE TABLE IF NOT EXISTS district_expenditure_20450251 (
    ...
    CONSTRAINT chk_20450251_exp2223 CHECK (expenditure_2022_23 >= 0),
    CONSTRAINT chk_20450251_exp2324 CHECK (expenditure_2023_24 >= 0),
    CONSTRAINT chk_20450251_exp2425 CHECK (expenditure_2024_25 >= 0),
    CONSTRAINT chk_20450251_be2526 CHECK (budget_estimate_2025_26 >= 0),
    CONSTRAINT chk_20450251_qe2025 CHECK (quarterly_expenditure_apr_jul_2025 >= 0),
    CONSTRAINT chk_20450251_be2627 CHECK (budget_estimate_2026_27 >= 0)
);
