...
CREATE INDEX idx_pld_budget_post ON post_level_details(table_name, budget_post_id);
CREATE INDEX idx_pld_subscheme ON post_level_details(sub_scheme_code);
CREATE INDEX idx_pld_fiscal_year ON post_level_details(fiscal_year);
CREATE INDEX idx_pld_order ON post_level_details(budget_post_id, level_order);
...
COMMENT ON COLUMN post_level_details.table_name IS 'Parent table name (e.g., budget_post_details_20530028)';
