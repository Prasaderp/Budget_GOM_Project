...
CREATE TABLE IF NOT EXISTS district_expenditure_22350311 (
    ...
    sub_scheme_code VARCHAR(15) NOT NULL DEFAULT '22350311',
...
CREATE INDEX IF NOT EXISTS idx_district_exp_22350311_fiscal_year ON district_expenditure_22350311(fiscal_year);
CREATE INDEX IF NOT EXISTS idx_district_exp_22350311_scheme_code ON district_expenditure_22350311(scheme_code);
CREATE INDEX IF NOT EXISTS idx_district_exp_22350311_sub_scheme_code ON district_expenditure_22350311(sub_scheme_code);
CREATE INDEX IF NOT EXISTS idx_district_exp_22350311_district ON district_expenditure_22350311(district);
