"""SQL generation for 0029 - multi-table aware"""
    ...
    if cached_prompt:
        ...
        if config:
            ...
            context = {
                ...
                'data_relationships': 'Multi-table structure, 4 tables',
                'common_patterns': '6 Konkan districts, historical 2011-2021',
