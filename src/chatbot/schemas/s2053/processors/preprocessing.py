...
def preprocess_question(question: str) -> str:
    ...
    marathi_to_english = {
        ...
        'जिल्हाधिकारी': 'Collector', 'कलेक्टर': 'Collector', 'अपर जिल्हाधिकारी': 'Additional Collector', 'अप्पर जिल्हाधिकारी': 'Additional Collector',
        'उपजिल्हाधिकारी': 'Deputy Collector', 'तहसीलदार': 'Tehsildar', 'तहसिलदार': 'Tehsildar', 'tehsildar': 'Tehsildar', 'tahsildar': 'Tehsildar',
        'चिटणीस': 'Chitnis', 'नायब तहसीलदार': 'Naib Tehsildar', 'नायब तहसिलदार': 'Naib Tehsildar',
        'लेखाधिकारी': 'Accounts Officer', 'सहा. लेखाधिकारी': 'Asst. Accounts Officer', 'सहायक लेखाधिकारी': 'Asst. Accounts Officer',
        'उपलेखापाल': 'Deputy Accountant', 'लघुलेखक': 'Stenographer', 'स्टेनो': 'Stenographer',
        ...
        'शिपाई': 'Peon/Naik/Havaldar/Watchman/Cleaner', 'चपडासी': 'Peon', 'चापडासी': 'Peon',
        'चपरासी': 'Peon/Naik/Havaldar/Watchman/Cleaner', 'चापरासी': 'Peon/Naik/Havaldar/Watchman/Cleaner',
        'नाईक': 'Peon/Naik/Havaldar/Watchman/Cleaner', 'हवालदार': 'Peon/Naik/Havaldar/Watchman/Cleaner',
        'वॉचमन': 'Peon/Naik/Havaldar/Watchman/Cleaner', 'पहारेकरी': 'Peon/Naik/Havaldar/Watchman/Cleaner',
        'स्वच्छक': 'Peon/Naik/Havaldar/Watchman/Cleaner', 'सफाई कामगार': 'Peon/Naik/Havaldar/Watchman/Cleaner',
        'विधी अधिकारी': 'Law Officer (Honorarium)', 'कायदा अधिकारी': 'Law Officer (Honorarium)',
        'मंडळ अधिकारी': 'Divisional Officer', 'वर्तुळ अधिकारी': 'Divisional Officer',
        'भूमापक': 'Land Surveyor', 'वसूली कारकून': 'Recovery Clerk', 'आरेखक': 'Draftsman', 'शिरस्तेदार': 'Shirastedar',
        'टेलिफोन ऑपरेटर': 'Telephone Operator', 'टेली ऑपरेटर': 'Telephone Operator',
        'लघुटंकलेखक': 'Steno-Typist', 'परिविक्षाधीन': 'Probationary', 'परिक्षण': 'Probationary', 
        'नायक': 'Naik', 'चौकीदार': 'Watchman', 'सफाईकर्मी': 'Cleaner', 'मुख्य लिपिक': 'Head Clerk',
        'स्टेनोग्राफर': 'Stenographer', 'टंकलेखक': 'Stenographer', 'मसुदानवीस': 'Draftsman',
        'हिसोब अधिकारी': 'Accounts Officer', 'सहाय्यक हिसोब अधिकारी': 'Asst. Accounts Officer',
        'संगणक खर्च': 'computer expenditure', 'संगणक': 'computer', 'कर्मचारी': 'employee',
    ...
    hindi_to_english = {
        'मूल वेतन': 'basic pay', 'बेसिक पे': 'basic pay', 'तनख्वाह': 'salary', 'जिलाधिकारी': 'Collector',
        'तहसीलदार': 'Tehsildar', 'चपरासी': 'Peon', 'सफाईकर्मी': 'Cleaner', 'क्लर्क': 'Clerk', 'चालक': 'Vehicle Driver',
