"""Security policy for subschema 20530019."""
...
class _Policy20530019(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20530019.
...
POLICY: SubschemeSecurityPolicy = _Policy20530019()
