"""Security policy for subschema 20530242."""
...
class _Policy20530242(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20530242.
...
POLICY: SubschemeSecurityPolicy = _Policy20530242()
