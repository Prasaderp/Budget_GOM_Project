"""Security policy for subschema 20530153."""
...
class _Policy20530153(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20530153.
...
POLICY: SubschemeSecurityPolicy = _Policy20530153()
