"""Security policy for subschema 20530378."""
...
class _Policy20530378(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20530378.
...
POLICY: SubschemeSecurityPolicy = _Policy20530378()
