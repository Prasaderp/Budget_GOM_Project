"""Security policy for subschema 20530233."""
...
class _Policy20530233(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20530233.
...
POLICY: SubschemeSecurityPolicy = _Policy20530233()
