"""Security policy for subschema 20530162."""
...
class _Policy20530162(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20530162.
...
POLICY: SubschemeSecurityPolicy = _Policy20530162()
