"""Security policy for subschema 20530304."""
...
class _Policy20530304(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20530304.
...
POLICY: SubschemeSecurityPolicy = _Policy20530304()
