"""Security policy for subschema 20530313."""
...
class _Policy20530313(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20530313.
...
POLICY: SubschemeSecurityPolicy = _Policy20530313()
