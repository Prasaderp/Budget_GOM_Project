...
- COLUMN NAMING: Fiscal data columns use relative names. Examples: expenditure_prev1 = expenditure 1 year ago, expenditure_curr = current year expenditure, budget_prev1 = budget from 1 year ago, sanctioned_posts_curr = current year sanctioned posts. Use the exact column names from the FISCAL YEAR COLUMNS section below.
