...
4. Aliases: de (district_expenditure_2215)
...
8. When matching district names, use ILIKE '%DistrictName%' because DB district field contains full office names (e.g. 'Collector Thane').
