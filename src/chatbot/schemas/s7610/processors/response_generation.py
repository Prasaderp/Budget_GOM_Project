"""Response generation for 7610 - formats public health expenditure data with bilingual support"""
import json
...
def generate_response(question: str, results: Any) -> str:
    """
    Generate natural language response from SQL results for 7610.
