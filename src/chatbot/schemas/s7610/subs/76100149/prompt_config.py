"""Subschema-specific prompt customizations for 76100149 - Public Health Program"""
...
# Unified schema pattern (same for all 4 subschemes)
PROMPT_CONFIG = PromptConfig(
    custom_context={
        'data_relationships': """- district_expenditure_76100149: District-wise public health program expenditure
  ...
  * COLUMNS:
    ...
    - "sub_scheme_code" (VARCHAR): '76100149'
...
- Current fiscal year for filtering: '2025-26'""",
        ...
        'examples': """Question: ठाणे चा अर्थसंकल्पीय अंदाज
SQL Query: SELECT de."district", de."budget_estimate"
FROM district_expenditure_76100149 de
...
ORDER BY de."revised_estimate" DESC
LIMIT {top_k};

Question: 2024-25 चा खर्च
SQL Query: SELECT de."district", de."expenditure_2024_25"
FROM district_expenditure_76100149 de
WHERE de."fiscal_year" = '2025-26'
ORDER BY de."expenditure_2024_25" DESC
LIMIT {top_k};

Question: एकूण अर्थसंकल्पीय अंदाज
SQL Query: SELECT SUM(de."budget_estimate") as total_budget
FROM district_expenditure_76100149 de
WHERE de."fiscal_year" = '2025-26'
LIMIT {top_k};"""
    },
    table_names={
        'district_expenditure_table': 'district_expenditure_76100149'
    }
)
