"""Subschema-specific prompt customizations for 76101871 - Public Health Program"""
...
PROMPT_CONFIG = PromptConfig(
    custom_context={
        'data_relationships': """- district_expenditure_76101871: District-wise public health program expenditure
  ...
  * COLUMNS:
    ...
    - "sub_scheme_code" (VARCHAR): '76101871'
...
LIMIT {top_k};"""
    ...
    table_names={
        'district_expenditure_table': 'district_expenditure_76101871'
    }
)
