"""Subschema-specific prompt customizations for 20750294."""
...
PROMPT_CONFIG = PromptConfig(
    custom_context={
        "data_relationships": """- sub_head_expenditure_20750294: Single-table sub-head/minor-head expenditure for scheme 2075, sub-scheme 20750294.
  * GRAIN: Each row represents a single (fiscal_year, sub_head) combination scoped to this sub-scheme (sub_scheme_code = '20750294').
  * COLUMNS:
    - \"fiscal_year\" (CHAR(7)): e.g. '2025-26'
    - \"scheme_code\" (VARCHAR): always '2075' for this table
    - \"sub_scheme_code\" (VARCHAR): always '20750294'
...
- Use only columns from sub_head_expenditure_20750294; do NOT reference 2053-style tables.
- Grouping:
...
- Important:
  ...
  * All queries must stay within sub_head_expenditure_20750294.
...
FROM sub_head_expenditure_20750294 she
...
Question: Total expenditure in 2023-24 across all sub-heads for this sub-scheme.
SQL Query: SELECT
  SUM(she."expenditure_2023_24") AS total_expenditure_2023_24
FROM sub_head_expenditure_20750294 she
WHERE she."sub_scheme_code" = '20750294'
LIMIT {top_k};
...
LIMIT {top_k};""",
    ...
    table_names={
        ...
        "budget_post_details_table": "sub_head_expenditure_20750294",
        "post_status_table": "sub_head_expenditure_20750294",
        "post_expenses_table": "sub_head_expenditure_20750294",
        "unit_expenditure_table": "sub_head_expenditure_20750294",
    },
)
