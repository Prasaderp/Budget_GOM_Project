"""Security policy for subschema 20750294."""
...
class _Policy20750294(SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20750294.
    ...
    _ALLOWED_LEVEL = "dco"
    _TABLE_NAME = "sub_head_expenditure_20750294"
    ...
    def enforce_sql(
        ...
        """
        Enforce read-only, subscheme-scoped SQL for sub_head_expenditure_20750294.
        """
        if not self._is_dco_user(user_context):
...
POLICY: SubschemeSecurityPolicy = _Policy20750294()
