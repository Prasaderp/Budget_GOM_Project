"""Security policy for subschema 22350338."""
...
class _Policy22350338(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
...
POLICY: SubschemeSecurityPolicy = _Policy22350338()
