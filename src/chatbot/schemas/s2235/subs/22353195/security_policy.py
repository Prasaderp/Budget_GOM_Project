"""Security policy for subschema 22353195."""
...
class _Policy22353195(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
...
POLICY: SubschemeSecurityPolicy = _Policy22353195()
