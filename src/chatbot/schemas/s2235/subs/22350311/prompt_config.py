"""Subschema-specific prompt customizations for 22350311 - Social Security (District Expenditure)"""
...
# Schema Pattern: revised_grant_2025_26, no expenditure_2024_25
PROMPT_CONFIG = PromptConfig(
    custom_context={
        'data_relationships': """- district_expenditure_22350311: District-wise social security expenditure
  ...
  * COLUMNS:
    ...
    - "sub_scheme_code" (VARCHAR): '22350311'
...
- Current fiscal year for filtering: '2025-26'""",
        ...
        'examples': """Question: ठाणे जिल्ह्याचा 2022-23 चा खर्च
SQL Query: SELECT de."district", de."expenditure_2022_23"
FROM district_expenditure_22350311 de
WHERE de."fiscal_year" = '2025-26' AND de."district" = 'Thane'
LIMIT {top_k};

Question: सुधारित अनुदान 2025-26 मुंबई शहरासाठी
...
Question: अर्थसंकल्पीय अनुदान 2024-25 सर्व जिल्ह्यांसाठी
SQL Query: SELECT de."district", de."budget_grant_2024_25"
FROM district_expenditure_22350311 de
WHERE de."fiscal_year" = '2025-26'
ORDER BY de."budget_grant_2024_25" DESC
LIMIT {top_k};"""
    },
    table_names={
        'district_expenditure_table': 'district_expenditure_22350311'
    }
)
