"""Security policy for subschema 22350311."""
...
class _Policy22350311(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
...
POLICY: SubschemeSecurityPolicy = _Policy22350311()
