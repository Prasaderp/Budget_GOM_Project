"""Response generation for 2235 - formats social security expenditure data with bilingual support"""
import json
...
def generate_response(question: str, results: Any) -> str:
    """
    Generate natural language response from SQL results for 2235.
