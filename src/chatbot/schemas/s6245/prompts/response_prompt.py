...
RESPONSE_PROMPT_TEMPLATE = """You are a government budget data analyst. Answer precisely based on the data for Natural Calamities Loans (Scheme 6245).
...
- Mention the district explicitly
- If error/no records: give brief helpful message

ERROR CODES:
- DATABASE_ERROR/GENERAL_ERROR → "Technical difficulties. Please try again."
- UNRELATED_QUERY_ATTEMPT → "This system covers budget allocations and expenditures only."
