...
PROMPT_CONFIG = PromptConfig(
    custom_context={
        "data_relationships": """- district_expenditure_62450017: Single-table district-wise expenditure and budget data for scheme 62450017 (Other Loans for Natural Calamities).
  * GRAIN: Each row represents a single (fiscal_year, sub_scheme_code, district) combination.
  * KEY COLUMNS:
    - "fiscal_year" (CHAR(7)): e.g. '2025-26'
    - "scheme_code": always '6245'
