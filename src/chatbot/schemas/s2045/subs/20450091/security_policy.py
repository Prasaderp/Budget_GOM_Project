"""Security policy for subschema 20450091."""
...
class _Policy20450091(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20450091.
...
POLICY: SubschemeSecurityPolicy = _Policy20450091()
