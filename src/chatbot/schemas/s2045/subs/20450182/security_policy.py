"""Security policy for subschema 20450182."""
...
class _Policy20450182(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20450182.
...
POLICY: SubschemeSecurityPolicy = _Policy20450182()
