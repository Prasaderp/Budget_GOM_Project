"""Security policy for subschema 20450251."""
...
class _Policy20450251(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20450251.

    - Restricts division-level queries to elevated roles.
    - Prevents district-level users from querying other districts.
    - Note: This scheme only has 5 districts (no Mumbai City/Suburban)
    """
...
POLICY: SubschemeSecurityPolicy = _Policy20450251()
