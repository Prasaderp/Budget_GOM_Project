"""Security policy for subschema 20450262."""
...
class _Policy20450262(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20450262.
...
POLICY: SubschemeSecurityPolicy = _Policy20450262()
