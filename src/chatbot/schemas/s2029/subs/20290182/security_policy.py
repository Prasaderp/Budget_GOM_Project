"""Security policy for subschema 20290182."""
...
class _Policy20290182(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20290182.
...
POLICY: SubschemeSecurityPolicy = _Policy20290182()
