"""Security policy for subschema 20290037."""
...
class _Policy20290037(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20290037.
...
POLICY: SubschemeSecurityPolicy = _Policy20290037()
