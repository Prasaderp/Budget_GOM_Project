"""Security policy for subschema 20290262."""
...
class _Policy20290262(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20290262.
...
POLICY: SubschemeSecurityPolicy = _Policy20290262()
