"""Subschema-specific prompt customizations for 20290262"""
...
FROM budget_post_details_20290262 bpd
...
FROM unit_expenditure_20290262 ue
...
FROM post_expenses_20290262 pe
...
LIMIT {top_k};""",
    ...
    table_names={
        "budget_post_details_table": "budget_post_details_20290262",
        "post_status_table": "post_status_20290262",
        "post_expenses_table": "post_expenses_20290262",
        "unit_expenditure_table": "unit_expenditure_20290262",
    },
)
