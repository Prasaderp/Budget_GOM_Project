"""Security policy for subschema 20290046."""
...
class _Policy20290046(DivisionDistrictSecurityMixin, SubschemeSecurityPolicy):
    """
    Subschema-specific security rules for 20290046.
...
POLICY: SubschemeSecurityPolicy = _Policy20290046()
