...
- Marathi to English mapping (UI terms):
  ...
  * Years like "२०२५-२६" → 2025-26""",
        "examples": """Question: What is the expenditure in 2023-24 for crop loans in Palghar?
SQL Query: SELECT de."district", de."expenditure_2023_24" FROM district_expenditure_64010018 de WHERE de."district" ILIKE '%Palghar%' AND de."fiscal_year" = '2023-24' LIMIT {top_k};

Question: ठाणे जिल्हा 2025-26 चे पीक कर्ज बजेट किती आहे?
SQL Query: SELECT de."district", de."budget_grant_2025_26" FROM district_expenditure_64010018 de WHERE de."district" ILIKE '%Thane%' AND de."fiscal_year" = '2025-26' LIMIT {top_k};""",
    },
    table_names=None,
)
