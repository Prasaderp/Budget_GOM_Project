"""Response generation for 64010018 - formats crop loan expenditure data with bilingual support"""
import json
...
def generate_response(question: str, results: Any) -> str:
    """
    Generate natural language response from SQL results for 64010018.
    
    Logic: Format with Indian currency, summaries, bilingual context
    """
    llm = _init_llm()
