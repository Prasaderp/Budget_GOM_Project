...
21. TABLE ALIASES: Always use aliases - bpd (budget_post_details_20530028 or budget_post_details_20530162), ps (post_status_20530028 or post_status_20530162), pe (post_expenses_20530028 or post_expenses_20530162), ue (unit_expenditure_20530028 or unit_expenditure_20530162). Use the table name that matches the sub-scheme being queried.
...
- budget_post_details_20530028 / budget_post_details_20530162: Sanctioned posts, pay scales, allowances by district/category/class/designation. Use the table matching the sub-scheme being queried.
...
- post_status_20530028 / post_status_20530162: Current filled/vacant status and salary data by district/category/class. Use the table matching the sub-scheme being queried.
- post_expenses_20530028 / post_expenses_20530162: Expense calculations for filled/vacant posts by district/category/class. Use the table matching the sub-scheme being queried.
...
- unit_expenditure_20530028 / unit_expenditure_20530162: Multi-year expenditure tracking by district and unit account. Use the table matching the sub-scheme being queried.
...
SQL Query: SELECT AVG(ps."salary") as avg_salary, ps."district", ps."category" FROM post_status_20530028 ps WHERE ps."district" = 'Raigad' AND ps."category" = 'Permanent' GROUP BY ps."district", ps."category";

Question: Budget vs expenditure comparison for Thane 2023-24
SQL Query: SELECT ue."district", ue."unit_account", ue."budget_2024_25", ue."expenditure_2023_24", (ue."budget_2024_25" - ue."expenditure_2023_24") as variance FROM unit_expenditure_20530028 ue WHERE ue."district" = 'Thane' ORDER BY ue."unit_account" LIMIT {top_k};

Question: Which districts have highest total expenditure?
SQL Query: SELECT ue."district", SUM(ue."expenditure_2023_24") as total_expenditure FROM unit_expenditure_20530028 ue WHERE ue."expenditure_2023_24" IS NOT NULL GROUP BY ue."district" ORDER BY total_expenditure DESC LIMIT {top_k};

Question: Show all designations with their pay scales in Mumbai City
SQL Query: SELECT bpd."designation", bpd."basic_pay", bpd."grade_pay", bpd."category" FROM budget_post_details_20530028 bpd WHERE bpd."district" = 'Mumbai City' ORDER BY bpd."basic_pay" DESC LIMIT {top_k};

Question: Budget efficiency posts per rupee spent in each district
SQL Query: SELECT bpd."district", SUM(bpd."sanctioned_posts_2024_25" + bpd."sanctioned_posts_2025_26") AS total_posts, COALESCE(SUM(ue."budget_2024_25"), 0) AS total_budget FROM budget_post_details_20530028 bpd LEFT JOIN unit_expenditure_20530028 ue ON bpd."district" = ue."district" GROUP BY bpd."district" ORDER BY total_posts DESC LIMIT {top_k};

Question: Compare allowance patterns between Mumbai City and Mumbai Suburban
SQL Query: SELECT bpd."district", SUM(bpd."local_supplementary_allowance") AS local_supplementary_allowance, SUM(bpd."vehicle_allowance") AS vehicle_allowance, SUM(bpd."washing_allowance") AS washing_allowance, SUM(bpd."cash_allowance") AS cash_allowance, SUM(bpd."footwear_allowance_other") AS footwear_allowance_other FROM budget_post_details_20530028 bpd WHERE bpd."district" IN ('Mumbai City', 'Mumbai Suburban') GROUP BY bpd."district" ORDER BY bpd."district" LIMIT {top_k};
...
SQL Query: SELECT ue."district", ue."unit_account", ue."expenditure_2022_23" FROM unit_expenditure_20530028 ue WHERE ue."district" = 'Palghar' AND ue."unit_account" ILIKE '%Computer%' LIMIT {top_k};

Question: Mumbai City data of Class-4 employees
SQL Query: SELECT bpd."district", bpd."designation", bpd."class_type", bpd."category", bpd."sanctioned_posts_2024_25", bpd."basic_pay" FROM budget_post_details_20530028 bpd WHERE bpd."district" = 'Mumbai City' AND bpd."class_type" = 'Class-4' LIMIT {top_k};

Question: What is estimated Expenditure of medical expenses for the Konkan division
SQL Query: SELECT "district", MAX("medical_expenses") as medical_expenditure FROM post_expenses_20530028 WHERE "district" IN ('Mumbai City', 'Mumbai Suburban', 'Thane', 'Palghar', 'Raigad', 'Ratnagiri', 'Sindhudurg') AND "district" != 'DCO Staff' GROUP BY "district" ORDER BY medical_expenditure DESC LIMIT {top_k};
...
SQL Query: SELECT "district", MAX("medical_expenses") as medical_expenses FROM post_expenses_20530028 WHERE "district" = 'Thane' GROUP BY "district" LIMIT {top_k};
...
SQL Query: SELECT "district", MAX("medical_expenses") as medical_expenses FROM post_expenses_20530028 WHERE "district" = 'Mumbai Suburban' GROUP BY "district" LIMIT {top_k};

Question: Festival advance budget for Raigad district
SQL Query: SELECT "district", MAX("festival_advance") as festival_advance FROM post_expenses_20530028 WHERE "district" = 'Raigad' GROUP BY "district" LIMIT {top_k};

Question: What is NPS expenditure for Konkan division
SQL Query: SELECT "district", MAX("nps") as nps_expenditure FROM post_expenses_20530028 WHERE "district" IN ('Mumbai City', 'Mumbai Suburban', 'Thane', 'Palghar', 'Raigad', 'Ratnagiri', 'Sindhudurg') AND "district" != 'DCO Staff' GROUP BY "district" ORDER BY nps_expenditure DESC LIMIT {top_k};

Question: Festival advance for Mumbai City
SQL Query: SELECT "district", MAX("festival_advance") as festival_advance FROM post_expenses_20530028 WHERE "district" = 'Mumbai City' GROUP BY "district" LIMIT {top_k};

Question: उत्सव/सण अग्रिम for Thane
SQL Query: SELECT "district", MAX("festival_advance") as festival_advance FROM post_expenses_20530028 WHERE "district" = 'Thane' GROUP BY "district" LIMIT {top_k};

Question: 7th Pay Commission Difference for all districts
SQL Query: SELECT "district", MAX("seventh_pay_commission_difference") as commission_difference FROM post_expenses_20530028 GROUP BY "district" ORDER BY commission_difference DESC LIMIT {top_k};
...
SQL Query: SELECT SUM("sanctioned_posts_2024_25" + "sanctioned_posts_2025_26") as total_posts, "district", "designation" FROM budget_post_details_20530028 WHERE "district" = 'Thane' AND "designation" LIKE '%Tehsildar%' GROUP BY "district", "designation" LIMIT {top_k};

Question: How many sanctioned posts for Deputy Collector in Mumbai City
SQL Query: SELECT SUM("sanctioned_posts_2024_25" + "sanctioned_posts_2025_26") as total_posts, "district", "designation" FROM budget_post_details_20530028 WHERE "district" = 'Mumbai City' AND "designation" = 'Deputy Collector' GROUP BY "district", "designation" LIMIT {top_k};

Question: Total posts of Clerk in Raigad district
SQL Query: SELECT SUM("sanctioned_posts_2024_25" + "sanctioned_posts_2025_26") as total_posts, "district", "designation" FROM budget_post_details_20530028 WHERE "district" = 'Raigad' AND "designation" LIKE '%Clerk%' GROUP BY "district", "designation" LIMIT {top_k};

Question: Number of Vehicle Driver posts in Sindhudurg
SQL Query: SELECT SUM("sanctioned_posts_2024_25" + "sanctioned_posts_2025_26") as total_posts, "district", "designation" FROM budget_post_details_20530028 WHERE "district" = 'Sindhudurg' AND "designation" = 'Vehicle Driver' GROUP BY "district", "designation" LIMIT {top_k};

Question: How many Peon posts are there in Palghar district
SQL Query: SELECT SUM("sanctioned_posts_2024_25" + "sanctioned_posts_2025_26") as total_posts, "district", "designation" FROM budget_post_details_20530028 WHERE "district" = 'Palghar' AND "designation" LIKE '%Peon%' GROUP BY "district", "designation" LIMIT {top_k};

Question: Total sanctioned posts for Accounts Officer across all districts
SQL Query: SELECT SUM("sanctioned_posts_2024_25" + "sanctioned_posts_2025_26") as total_posts, "district", "designation" FROM budget_post_details_20530028 WHERE "designation" = 'Accounts Officer' GROUP BY "district", "designation" ORDER BY total_posts DESC LIMIT {top_k};
...
SQL Query: SELECT SUM("sanctioned_posts_2024_25" + "sanctioned_posts_2025_26") as total_posts, "district", "designation" FROM budget_post_details_20530028 WHERE "district" = 'Thane' AND "designation" LIKE '%Clerk%' GROUP BY "district", "designation" LIMIT {top_k};

Question: वाहन चालक posts in Raigad
SQL Query: SELECT SUM("sanctioned_posts_2024_25" + "sanctioned_posts_2025_26") as total_posts, "district", "designation" FROM budget_post_details_20530028 WHERE "district" = 'Raigad' AND "designation" = 'Vehicle Driver' GROUP BY "district", "designation" LIMIT {top_k};
