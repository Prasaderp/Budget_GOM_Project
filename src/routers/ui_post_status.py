...
async def ui_list_post_status(
    ...
    if view == "summary":
        ...
        response = templates.TemplateResponse("post_status_list.html", context)
...
async def ui_update_post_status( request: Request, id: int, db: Session = Depends(get_db), District: str = Form(...), Category: str = Form(...), Class: str = Form(...), Status: str = Form(...), Posts: Optional[int] = Form(None), Salary: Optional[int] = Form(None), GradePay: Optional[int] = Form(None), SpecialPay: Optional[int] = Form(None), DearnessAllowance: Optional[int] = Form(None), LocalSupplemetoryAllowance: Optional[int] = Form(None), HouseRentAllowance: Optional[int] = Form(None), TravelAllowance: Optional[int] = Form(None), Other: Optional[int] = Form(None) ):
    ...
    try:
        ...
        if auth_level == 'district' and auth_unit:
            districts_for_filter = [auth_unit]
        return templates.TemplateResponse("post_status_form.html", { "request": request, "error": f"रेकॉर्ड अपडेट करण्यात अयशस्वी: {e}", "districts": districts_for_filter, "categories": CATEGORIES, "classes": CLASSES_SHEET1_2, "statuses": STATUSES, "item": db_item, "resource_name": "प्रपत्र क संपादन", "districts_mr": DISTRICTS_MR, "categories_mr": CATEGORIES_MR, "classes_mr": CLASSES_MR, "statuses_mr": STATUSES_MR, "auth_level": auth_level }, status_code=400)
