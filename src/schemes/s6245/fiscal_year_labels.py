"""
Fiscal year label generator for scheme 6245 — Loans for Natural Calamities.

Converts a relative_years dict (from get_relative_fiscal_years) into
dynamic column header labels used in the district expenditure list and
form views for sub-scheme 62450017.

The s6245 expenditure table has 6 year columns:
...
Usage:
    ...
    labels = FiscalYearLabels6245(ry)
...
class FiscalYearLabels6245:
    """Immutable, zero-allocation label resolver for s6245 district expenditure views."""
