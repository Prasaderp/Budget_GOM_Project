"""Shared helper utilities for sub-scheme 62450017"""
...
_audit_executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix="audit_s62450017")
...
def ensure_fiscal_year_seeded(db: Session, fiscal_year: str) -> None:
    ...
    exists = (
        db.query(DistrictExpenditure62450017.id)
        .filter(
    ...
    rows: List[DistrictExpenditure62450017] = [
        DistrictExpenditure62450017(
...
def check_edit_permission_for_scheme(auth_role: str, auth_level: str, auth_unit: str, db: Session) -> bool:
    """Unified permission check for scheme 62450017"""
