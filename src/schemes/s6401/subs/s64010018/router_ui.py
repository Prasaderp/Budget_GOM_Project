"""UI routes for sub-scheme 64010018 district-wise expenditure."""
...
router = APIRouter(
    prefix="/ui/s64010018/district-expenditure",
    tags=["UI - 64010018 पीक उत्पादन कर्ज"],
...
async def ui_list_district_expenditure(
    ...
    if district:
        query = query.filter(DistrictExpenditure64010018.district == district)
    else:
        query = query.filter(DistrictExpenditure64010018.district.in_(allowed_districts))

    total_count = query.with_entities(func.count(DistrictExpenditure64010018.id)).scalar()
    items = (
        query.order_by(DistrictExpenditure64010018.district)
    ...
    context = {
        ...
        "can_edit": can_edit,
        "resource_name": "64010018 जिल्हानिहाय खर्च",
    ...
    return templates.TemplateResponse(
        "schemes/s6401/subs/s64010018/district_expenditure_list.html",
        context,
    )
...
async def ui_edit_district_expenditure_form(
    ...
    context = {
        ...
        "item": item,
        "districts": allowed_districts,
        "resource_name": "64010018 जिल्हानिहाय खर्च संपादन",
        "districts_mr": DISTRICTS_MR,
        "auth_level": auth_level,
        "auth_role": auth_role,
    }
    return templates.TemplateResponse(
        "schemes/s6401/subs/s64010018/district_expenditure_form.html",
        context,
    )
