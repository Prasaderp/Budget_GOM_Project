"""
Fiscal year label generator for scheme 6401 — Loans for Crop Husbandry.
...
form views for sub-scheme 64010018.

The s6401 expenditure table has 6 year columns:
...
Usage:
    ...
    labels = FiscalYearLabels6401(ry)
...
class FiscalYearLabels6401:
    """Immutable, zero-allocation label resolver for s6401 district expenditure views."""
