"""Shared helper utilities for sub-scheme 76100167"""
...
_audit_executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix="audit_s76100167")
...
def ensure_fiscal_year_seeded(db: Session, fiscal_year: str) -> None:
    ...
    rows: List[DistrictExpenditure76100167] = [
        DistrictExpenditure76100167(
