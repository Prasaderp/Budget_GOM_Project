"""Database models for sub-scheme 76100167."""
...
class DistrictExpenditure76100167(TalukaScopedMixin, Base):
    __tablename__ = "district_expenditure_76100167"
    ...
    sub_scheme_code = Column(String(15), nullable=False, default="76100167", server_default="76100167", index=True)
