"""Shared helper utilities for sub-scheme 76101871"""
...
_audit_executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix="audit_s76101871")
...
def ensure_fiscal_year_seeded(db: Session, fiscal_year: str) -> None:
    ...
    rows: List[DistrictExpenditure76101871] = [
        DistrictExpenditure76101871(
