"""UI routes for sub-scheme 76101871 district-wise expenditure."""
...
router = APIRouter(
    prefix="/ui/s76101871/district-expenditure",
    tags=["UI - 76101871 जिल्हानिहाय खर्च"],
...
async def ui_list_district_expenditure(
    ...
    query = (
        ...
        .filter(
            DistrictExpenditure76101871.fiscal_year == fiscal_year,
            DistrictExpenditure76101871.sub_scheme_code == SUB_SCHEME_CODE,
        )
    )

    if district:
        query = query.filter(DistrictExpenditure76101871.district == district)
    else:
        query = query.filter(DistrictExpenditure76101871.district.in_(allowed_districts))

    total_count = query.with_entities(func.count(DistrictExpenditure76101871.id)).scalar()
    items = (
        query.order_by(DistrictExpenditure76101871.district)
    ...
    context = {
        ...
        "can_edit": can_edit,
        "resource_name": "76101871 जिल्हानिहाय खर्च",
    ...
    return render(request, 
        "schemes/s7610/subs/s76101871/district_expenditure_list.html",
        context,
    )
...
async def ui_edit_district_expenditure_form(
    ...
    context = {
        ...
        "item": item,
        "districts": allowed_districts,
        "resource_name": "76101871 जिल्हानिहाय खर्च संपादन",
        "districts_mr": DISTRICTS_MR,
        "auth_level": auth_level,
        "auth_role": auth_role,
        "fy_labels": fy_labels,
    ...
    return render(request, 
        "schemes/s7610/subs/s76101871/district_expenditure_form.html",
        context,
    )
