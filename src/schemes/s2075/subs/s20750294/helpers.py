"""Shared helper utilities for sub-scheme 20750294"""
...
_audit_executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix="audit_s20750294")
...
def ensure_fiscal_year_seeded(db: Session, fiscal_year: str) -> None:
    ...
    exists = (
        db.query(SubHeadExpenditure20750294.id)
        .filter(
    ...
    row = SubHeadExpenditure20750294(
        fiscal_year=fiscal_year,
        scheme_code=SCHEME_CODE,
        sub_scheme_code=SUB_SCHEME_CODE,
        sub_head='मागणी क्र.सी-4-2075- संकिर्ण-सर्वसाधारण सेवा 101 (01) इनामदार व इतर अनुदानग्राही 04-निवृत्ती वेतने-(00) (01) आयुक्त कोकण (20750294)',
    )
    db.add(row)
    db.commit()
...
def check_edit_permission_for_scheme(auth_role: str, auth_level: str, auth_unit: str, db: Session) -> bool:
    """Unified permission check for scheme 20750294 - only DCO main assistant"""
