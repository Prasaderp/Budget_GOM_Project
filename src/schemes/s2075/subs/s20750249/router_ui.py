"""UI routes for sub-scheme 20750249 sub-head expenditure."""
...
from .models import SubHeadExpenditure20750249, SUB_SCHEME_CODE
from .helpers import (
    check_dco_access,
...
router = APIRouter(
    prefix="/ui/s20750249/sub-head-expenditure",
    tags=["UI - 20750249 उपशिर्ष / गौणशिर्ष खर्च"],
...
async def ui_list_sub_head_expenditure(
    ...
    total_count = query.with_entities(func.count(SubHeadExpenditure20750249.id)).scalar()
    items = (
        query.order_by(SubHeadExpenditure20750249.id)
    ...
    context = {
        ...
        "page_size": page_size,
        "can_edit": can_edit,
        "resource_name": "20750249 उपशिर्ष / गौणशिर्ष खर्च",
        "auth_level": auth_level,
        "auth_role": auth_role,
    }

    return templates.TemplateResponse(
        "schemes/s2075/subs/s20750249/sub_head_expenditure_list.html",
        context,
    )
...
async def ui_edit_sub_head_expenditure_form(
    ...
    context = {
        "request": request,
        "item": item,
        "resource_name": "20750249 उपशिर्ष / गौणशिर्ष खर्च संपादन",
        "auth_level": auth_level,
        "auth_role": auth_role,
    }
    return templates.TemplateResponse(
        "schemes/s2075/subs/s20750249/sub_head_expenditure_form.html",
        context,
    )
