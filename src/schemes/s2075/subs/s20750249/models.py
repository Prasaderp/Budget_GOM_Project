"""Database models for sub-scheme 20750249."""
from sqlalchemy import Column, Integer, String, BigInteger, CHAR, CheckConstraint, UniqueConstraint

from src.database import Base


class SubHeadExpenditure20750249(Base):
    __tablename__ = "sub_head_expenditure_20750249"
    ...
    __table_args__ = (
        UniqueConstraint(
            ...
            "sub_scheme_code",
            "sub_head",
            name="uq_sub_head_exp_20750249_natural_key",
        ),
        CheckConstraint("expenditure_2022_23 >= 0", name="chk_exp_2223_non_negative_20750249"),
        CheckConstraint("expenditure_2023_24 >= 0", name="chk_exp_2324_non_negative_20750249"),
        CheckConstraint("expenditure_2024_25 >= 0", name="chk_exp_2425_non_negative_20750249"),
        CheckConstraint("budget_estimate >= 0", name="chk_budget_est_non_negative_20750249"),
        CheckConstraint("revised_estimate >= 0", name="chk_revised_est_non_negative_20750249"),
        CheckConstraint("budget_estimate_2026_27 >= 0", name="chk_be_2627_non_negative_20750249"),
    )
