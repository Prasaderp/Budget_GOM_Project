"""UI routes for budget post details (Form D) - sub-scheme 20290182"""
...
router = APIRouter(prefix="/ui/s20290182/budget-post-details", tags=["UI - प्रपत्र ड"], include_in_schema=False)
...
async def ui_list_budget_details(
    ...
    if view == "summary":
        ...
        response = templates.TemplateResponse("schemes/s2029/subs/s20290182/budget_post_details_list.html", context)
...
async def ui_edit_budget_detail_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    response = templates.TemplateResponse("schemes/s2029/subs/s20290182/budget_post_details_form.html", {
        "request": request,
        "districts": districts_for_filter,
        "categories": CATEGORIES,
        "classes": CLASSES_SHEET1_2,
        ...
        "da_rate": da_rate,
        "api_base_path": "/ui/s20290182/budget-post-details/api/post-levels",
        "pay_matrix_api_path": "/ui/s20290182/budget-post-details/api/pay-matrix",
    ...
    try:
        ...
        if SanctionedPostsCurr is not None:
            ...
            current_level_count = post_level_repo.get_count(
                db_detail.id, sub_scheme, "budget_post_details_20290182", db_detail.fiscal_year
            )
        ...
        return templates.TemplateResponse("schemes/s2029/subs/s20290182/budget_post_details_form.html", {
            "request": request,
