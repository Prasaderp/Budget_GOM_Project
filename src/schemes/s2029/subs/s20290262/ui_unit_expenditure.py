"""UI routes for unit expenditure (Form A) - sub-scheme 20290262"""
...
router = APIRouter(prefix="/ui/s20290262/unit-expenditure", tags=["UI - प्रपत्र अ"], include_in_schema=False)
...
async def ui_list_unit_expenditure(
    ...
    if view == "summary":
        ...
        resp = templates.TemplateResponse("schemes/s2029/subs/s20290262/unit_expenditure_list.html", context)
...
async def ui_edit_unit_expenditure_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("schemes/s2029/subs/s20290262/unit_expenditure_form.html", {
        "request": request,
        "districts": districts_for_filter,
        "primary_units": PRIMARY_UNITS,
        "item": item,
