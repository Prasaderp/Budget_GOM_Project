"""Database models for sub-scheme 20290262 - District Administration (Charged)."""
...
class BudgetPostDetails20290262(BudgetDetailsMixin, Base):
    __tablename__ = "budget_post_details_20290262"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'designation',
                         name='uq_bpd_20290262_natural_key'),
        CheckConstraint('sanctioned_posts_2024_25 >= 0', name='chk_bpd_20290262_posts_2024_25'),
        CheckConstraint('sanctioned_posts_2025_26 >= 0', name='chk_bpd_20290262_posts_2025_26'),
        CheckConstraint('basic_pay >= 0', name='chk_bpd_20290262_basic_pay'),
        CheckConstraint("hra_rate IN ('X', 'Y', 'Z')", name='chk_bpd_20290262_hra_rate'),
    )


class PostStatus20290262(PostStatusMixin, Base):
    __tablename__ = "post_status_20290262"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'status',
                         name='uq_ps_20290262_natural_key'),
        CheckConstraint('posts >= 0', name='chk_ps_20290262_posts'),
        CheckConstraint('salary >= 0', name='chk_ps_20290262_salary'),
    )


class PostExpenses20290262(BudgetDetailsMixin, Base):
    __tablename__ = "post_expenses_20290262"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type',
                         name='uq_pe_20290262_natural_key'),
        CheckConstraint('filled_posts >= 0', name='chk_pe_20290262_filled_posts'),
        CheckConstraint('vacant_posts >= 0', name='chk_pe_20290262_vacant_posts'),
    )


class UnitExpenditure20290262(UnitExpenditureMixin, Base):
    __tablename__ = "unit_expenditure_20290262"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'unit_account',
                         name='uq_ue_20290262_natural_key'),
    )


BudgetPostDetails = BudgetPostDetails20290262
PostStatus = PostStatus20290262
PostExpenses = PostExpenses20290262
UnitExpenditure = UnitExpenditure20290262
