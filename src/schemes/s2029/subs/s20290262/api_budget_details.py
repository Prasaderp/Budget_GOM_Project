"""API controller for budget post details - sub-scheme 20290262"""
...
router = APIRouter(
    ...
    tags=["API - Budget Post Details 20290262"],
...
async def api_update_inline(
    ...
    current_level_count = post_level_repo.get_count(
        id, sub_scheme, "budget_post_details_20290262", record.fiscal_year
    )
