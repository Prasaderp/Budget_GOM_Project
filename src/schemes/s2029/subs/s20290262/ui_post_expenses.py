"""UI routes for post expenses (Form B) - sub-scheme 20290262"""
...
router = APIRouter(
    prefix="/ui/s20290262/post-expenses",
    tags=["UI - प्रपत्र ब"],
...
def get_post_expenses_summary_data(db: Session, fiscal_year: str = '2025-26', district: Optional[str] = None) -> Dict[str, Any]:
    ...
    try:
        ...
        table1_rows = []
        table1_totals: Dict[str, Any] = {
            "Permanent_Filled": 0, "Permanent_Vacant": 0, 
            "Temporary_Filled": 0, "Temporary_Vacant": 0, "Row_Total": 0
        }
        ...
        table3_totals_dict: Dict[str, float] = {
            'Medical': 0.0, 'Festival': 0.0, 'Swagram': 0.0,
            'SeventhPayNPS': 0.0, 'Other': 0.0, 'Expense_Total': 0.0
        }
...
async def ui_list_post_expenses(
    ...
    if view == "summary":
        ...
        response = templates.TemplateResponse("schemes/s2029/subs/s20290262/post_expenses_list.html", context)
...
async def ui_edit_post_expense_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("schemes/s2029/subs/s20290262/post_expenses_form.html", {
        "request": request,
        "districts": districts_for_filter,
        "categories": CATEGORIES,
        "classes": CLASSES_SHEET3,
