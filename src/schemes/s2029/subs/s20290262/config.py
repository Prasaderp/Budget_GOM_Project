"""Configuration for sub-scheme 20290262 - District Administration (Charged)"""
from src.core.base_config import BaseSchemeConfig, FormConfig

SCHEME_CODE = "2029"
SUB_SCHEME_CODE = "20290262"
...
SCHEME_CONFIG = BaseSchemeConfig(
    ...
    entry_point="/ui/s20290262/budget-post-details",
    ...
    forms={
        ...
        "post_status": FormConfig(
            name="post_status",
            table_name="post_status_20290262",
            label_mr="प्रपत्र क",
        ...
        "post_expenses": FormConfig(
            name="post_expenses",
            table_name="post_expenses_20290262",
            label_mr="प्रपत्र ब",
        ...
        "unit_expenditure": FormConfig(
            ...
            table_name="unit_expenditure_20290262",
            label_mr="प्रपत्र अ",
