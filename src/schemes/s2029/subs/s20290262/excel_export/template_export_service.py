"""Template-based Excel export service for sub-scheme 20290262.

Architecture mirrors 20290182 with hardcoded row mappings for merged-cell templates.
"""
import io
import os
        ...
        for ext in (".xlsx", ".xls"):
            for pattern in (
                ...
                if os.path.exists(path):
                    return path
    return "excel_templates/s2029/subs/s20290262/Budget 20290262 for 2026-27.xlsx"
...
def _get_processor_module(district: str):
    ...
    try:
        return __import__(
            f"src.schemes.s2029.subs.s20290262.excel_export.processors.{processor_name}",
