"""Database models for sub-scheme 20290037 - District Administration (Charged)."""
...
class BudgetPostDetails20290037(BudgetDetailsMixin, Base):
    __tablename__ = "budget_post_details_20290037"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'designation',
                         name='uq_bpd_20290037_natural_key'),
        CheckConstraint('sanctioned_posts_2024_25 >= 0', name='chk_bpd_20290037_posts_2024_25'),
        CheckConstraint('sanctioned_posts_2025_26 >= 0', name='chk_bpd_20290037_posts_2025_26'),
        CheckConstraint('basic_pay >= 0', name='chk_bpd_20290037_basic_pay'),
        CheckConstraint("hra_rate IN ('X', 'Y', 'Z')", name='chk_bpd_20290037_hra_rate'),
    )


class PostStatus20290037(PostStatusMixin, Base):
    __tablename__ = "post_status_20290037"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'status',
                         name='uq_ps_20290037_natural_key'),
        CheckConstraint('posts >= 0', name='chk_ps_20290037_posts'),
        CheckConstraint('salary >= 0', name='chk_ps_20290037_salary'),
    )


class PostExpenses20290037(BudgetDetailsMixin, Base):
    __tablename__ = "post_expenses_20290037"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type',
                         name='uq_pe_20290037_natural_key'),
        CheckConstraint('filled_posts >= 0', name='chk_pe_20290037_filled_posts'),
        CheckConstraint('vacant_posts >= 0', name='chk_pe_20290037_vacant_posts'),
    )


class UnitExpenditure20290037(UnitExpenditureMixin, Base):
    __tablename__ = "unit_expenditure_20290037"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'unit_account',
                         name='uq_ue_20290037_natural_key'),
    )


BudgetPostDetails = BudgetPostDetails20290037
PostStatus = PostStatus20290037
PostExpenses = PostExpenses20290037
UnitExpenditure = UnitExpenditure20290037
