"""Template-based Excel export service for sub-scheme 20290037.

Architecture mirrors 20290262 with hardcoded row mappings for merged-cell templates.
"""
import io
import os
        ...
        for ext in (".xlsx", ".xls"):
            for pattern in (
                ...
                if os.path.exists(path):
                    return path
    return "excel_templates/s2029/subs/s20290037/Budget 20290037 for 2026-27.xlsx"
...
def _get_processor_module(district: str):
    ...
    try:
        return __import__(
            f"src.schemes.s2029.subs.s20290037.excel_export.processors.{processor_name}",
