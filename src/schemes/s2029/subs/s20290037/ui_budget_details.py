...
async def ui_list_budget_details(
    ...
    if view == "summary":
        ...
        response = render(request, "schemes/s2029/subs/s20290037/budget_post_details_list.html", context)
...
async def ui_edit_budget_detail_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    response = render(request, "schemes/s2029/subs/s20290037/budget_post_details_form.html", {
        "request": request,
        "districts": districts_for_filter,
        "categories": CATEGORIES,
        "classes": CLASSES_SHEET1_2,
...
async def ui_update_budget_detail(
    ...
    try:
        ...
        return render(request, "schemes/s2029/subs/s20290037/budget_post_details_form.html", {
            "request": request,
