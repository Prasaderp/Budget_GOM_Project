"""Post status populator for sub-scheme 20290046.

8 districts (7 + DCO Staff), 3 class types, Permanent/Temporary categories.
"""
...
def _write_block(ws, db: Session, model, district: str, category: str, start_row: int, fiscal_year: Optional[str]):
