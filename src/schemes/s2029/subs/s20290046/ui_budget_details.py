"""UI routes for budget post details (Form D) - sub-scheme 20290046"""
...
from .helpers import (
    ...
    get_no_cache_headers, validate_numeric_inputs, validate_access_control
)
...
router = APIRouter(prefix="/ui/s20290046/budget-post-details", tags=["UI - प्रपत्र ड"], include_in_schema=False)
...
async def ui_list_budget_details(
    ...
    if view == "summary":
        ...
        response = templates.TemplateResponse("schemes/s2029/subs/s20290046/budget_post_details_list.html", context)
...
async def ui_edit_budget_detail_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    response = templates.TemplateResponse("schemes/s2029/subs/s20290046/budget_post_details_form.html", {
        "request": request,
        "districts": districts_for_filter,
        "categories": CATEGORIES,
        "classes": CLASSES_SHEET1_2,
        ...
        "da_rate": da_rate,
        "api_base_path": "/ui/s20290046/budget-post-details/api/post-levels",
        "pay_matrix_api_path": "/ui/s20290046/budget-post-details/api/pay-matrix",
    ...
    try:
        ...
        if SanctionedPostsCurr is not None:
            ...
            current_level_count = post_level_repo.get_count(
                db_detail.id, sub_scheme, "budget_post_details_20290046", db_detail.fiscal_year
            )
        ...
        return templates.TemplateResponse("schemes/s2029/subs/s20290046/budget_post_details_form.html", {
            "request": request,
...
async def export_budget_details_sheet_only(
    ...
    _, sub_scheme = get_scheme_from_cookies(request)
    fiscal_year = get_fiscal_year_from_request(request, db)
    return await export_original_workbook_async(db, only_sheet="budget_post_details", user_district=user_district, sub_scheme_code=sub_scheme, fiscal_year=fiscal_year)
