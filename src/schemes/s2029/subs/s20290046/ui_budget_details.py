...
async def ui_list_budget_details(
    ...
    if view == "summary":
        ...
        response = render(
            request,
            "schemes/s2029/subs/s20290046/budget_post_details_list.html",
            context,
        )
...
async def ui_edit_budget_detail_form(
    ...
    response = render(
        request,
        "schemes/s2029/subs/s20290046/budget_post_details_form.html",
        {
            "request": request,
            "districts": districts_for_filter,
            "categories": CATEGORIES,
    ...
    try:
        ...
        if SanctionedPostsCurr is not None:
            ...
            current_level_count = post_level_repo.get_count(
                id, sub_scheme, "budget_post_details_20290046", db_detail.fiscal_year
            )
