"""API controller for budget post details - sub-scheme 20290046"""
...
router = APIRouter(
    prefix="/ui/s20290046/budget-post-details",
    tags=["API - Budget Post Details 20290046"],
...
async def api_update_inline(
    ...
    current_level_count = post_level_repo.get_count(
        id, sub_scheme, "budget_post_details_20290046", record.fiscal_year
    )
