"""UI routes for unit expenditure (Form A) - sub-scheme 20290046"""
...
router = APIRouter(prefix="/ui/s20290046/unit-expenditure", tags=["UI - प्रपत्र अ"], include_in_schema=False)
...
async def ui_list_unit_expenditure(
    ...
    if view == "summary":
        ...
        resp = templates.TemplateResponse("schemes/s2029/subs/s20290046/unit_expenditure_list.html", context)
...
async def ui_edit_unit_expenditure_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    fiscal_year = get_fiscal_year_from_request(request, db)
    relative_years = get_relative_fiscal_years(fiscal_year)
    return templates.TemplateResponse("schemes/s2029/subs/s20290046/unit_expenditure_form.html", {
        "request": request,
        "districts": districts_for_filter,
        "primary_units": PRIMARY_UNITS,
        "item": item,
...
async def export_unit_expenditure_summary_excel(request: Request, db: Session = Depends(get_db)):
    ...
    headers_map = {
        ...
        "expenditure_prev4": "प्रत्यक्ष रक्कमा पूर्वीचे वर्ष ४",
        "expenditure_prev3": "प्रत्यक्ष रक्कमा पूर्वीचे वर्ष ३",
        "expenditure_prev2": "प्रत्यक्ष रक्कमा पूर्वीचे वर्ष २",
        "budget_prev1": "अर्थसंकल्पीय अंदाज मागील वर्ष",
        "forecast_prev1": "सुधारीत अंदाज मागील वर्ष",
        "budget_curr_estimating_officer": "अर्थसंकल्पीय प्राकक्लन",
        "budget_curr_controlling_officer": "अर्थसंकल्पीय नियंत्रक",
        "budget_curr_admin_dept": "अर्थसंकल्पीय प्रशासकीय",
        "budget_curr_finance_dept": "अर्थसंकल्पीय वित्त",
    }
