"""UI routes for post expenses (Form B) - sub-scheme 20290046"""
...
router = APIRouter(
    prefix="/ui/s20290046/post-expenses",
    tags=["UI - प्रपत्र ब"],
...
async def ui_list_post_expenses(
    ...
    if view == "summary":
        ...
        response = templates.TemplateResponse("schemes/s2029/subs/s20290046/post_expenses_list.html", context)
...
async def ui_edit_post_expense_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    return templates.TemplateResponse("schemes/s2029/subs/s20290046/post_expenses_form.html", {
        "request": request,
        "districts": districts_for_filter,
        "categories": CATEGORIES,
        "classes": CLASSES_SHEET3,
...
async def ui_update_post_expense(
    ...
    try:
        ...
        return templates.TemplateResponse("schemes/s2029/subs/s20290046/post_expenses_form.html", {
            "request": request,
            "error": "Failed to update record. Please check inputs.",
            "districts": districts_for_filter,
            "categories": CATEGORIES,
            "classes": CLASSES_SHEET3,
