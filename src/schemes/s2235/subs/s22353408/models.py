"""Database models for sub-scheme 22353408 - Welfare of the Elderly (Subsidies Non-Salary)."""
...
class DistrictExpenditure22353408(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("revised_estimate_2025_26 >= 0", name="chk_22353408_re_2526_non_negative"),
