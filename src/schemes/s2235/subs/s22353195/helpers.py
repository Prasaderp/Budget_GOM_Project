"""Shared helper utilities for sub-scheme 22353195"""
...
_audit_executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix="audit_s22353195")
...
def ensure_fiscal_year_seeded(db: Session, fiscal_year: str) -> None:
    ...
    exists = (
        db.query(DistrictExpenditure22353195.id)
        .filter(
    ...
    rows: List[DistrictExpenditure22353195] = [
        DistrictExpenditure22353195(
...
def check_edit_permission_for_scheme(auth_role: str, auth_level: str, auth_unit: str, db: Session) -> bool:
    """Unified permission check for scheme 22353195"""
