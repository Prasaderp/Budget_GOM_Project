...
class DistrictExpenditure22350311(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("expenditure_2024_25 >= 0", name="chk_22350311_exp_2425_non_negative"),
        CheckConstraint("budget_grant_2025_26 >= 0", name="chk_22350311_bg_2526_non_negative"),
