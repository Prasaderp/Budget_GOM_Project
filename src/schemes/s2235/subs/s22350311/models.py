...
class DistrictExpenditure22350311(TalukaScopedMixin, Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("expenditure_prev2 >= 0", name="chk_22350311_exp_2324_non_negative"),
        CheckConstraint("expenditure_prev1 >= 0", name="chk_22350311_exp_2425_non_negative"),
        CheckConstraint("budget_grant_curr >= 0", name="chk_22350311_bg_2526_non_negative"),
        CheckConstraint("revised_grant_curr >= 0", name="chk_22350311_rg_2526_non_negative"),
        CheckConstraint("budget_estimate_next >= 0", name="chk_22350311_be_2627_non_negative"),
    )
