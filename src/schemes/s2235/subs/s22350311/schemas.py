"""Pydantic schemas for sub-scheme 22350311 district-wise expenditure."""
...
class DistrictExpenditureBase(BaseModel):
    ...
    budget_grant_curr: Optional[int] = 0
    revised_grant_curr: Optional[int] = 0
...
class DistrictExpenditureCreate(DistrictExpenditureBase):
    ...
    def validate_district(cls, v: str) -> str:
        if v not in KONKAN_DISTRICTS:
            raise ValueError("Invalid district for 22350311")
        return v
