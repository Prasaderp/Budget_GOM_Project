...
async def ui_edit_district_expenditure_form(
    ...
    item = db.query(DistrictExpenditure22350338).filter(DistrictExpenditure22350338.id == id).first()
    if not item:
...
async def ui_division_total(
    ...
    totals = (
        db.query(
            func.sum(DistrictExpenditure22350338.expenditure_2022_23).label("total_exp_2022_23"),
            func.sum(DistrictExpenditure22350338.expenditure_2023_24).label("total_exp_2023_24"),
            func.sum(DistrictExpenditure22350338.expenditure_2024_25).label("total_exp_2024_25"),
            func.sum(DistrictExpenditure22350338.budget_grant_2025_26).label("total_bg_2025_26"),
            func.sum(DistrictExpenditure22350338.revised_grant_2025_26).label("total_rg_2025_26"),
            func.sum(DistrictExpenditure22350338.budget_estimate_2026_27).label("total_be_2026_27"),
        )
        .filter(
            DistrictExpenditure22350338.fiscal_year == fiscal_year,
            DistrictExpenditure22350338.sub_scheme_code == SUB_SCHEME_CODE,
