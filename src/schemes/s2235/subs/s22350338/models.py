...
class DistrictExpenditure22350338(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("expenditure_2022_23 >= 0", name="chk_22350338_exp_2223_non_negative"),
        CheckConstraint("expenditure_2023_24 >= 0", name="chk_22350338_exp_2324_non_negative"),
        CheckConstraint("expenditure_2024_25 >= 0", name="chk_22350338_exp_2425_non_negative"),
        CheckConstraint("budget_grant_2025_26 >= 0", name="chk_22350338_bg_2526_non_negative"),
        CheckConstraint("revised_grant_2025_26 >= 0", name="chk_22350338_rg_2526_non_negative"),
        CheckConstraint("budget_estimate_2026_27 >= 0", name="chk_22350338_be_2627_non_negative"),
    )
