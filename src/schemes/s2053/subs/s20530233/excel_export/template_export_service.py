"""Template-based Excel export service for sub-scheme 20530233.
...
def _get_template_path(sub_scheme_code: Optional[str] = None) -> str:
    ...
    # Default fallback
    return "excel_templates/s2053/subs/s20530233/Budget 20530233 for 2026-27.xlsx"
...
def _get_processor_module(district: str):
    ...
    try:
        processor_module = __import__(
            f'src.schemes.s2053.subs.s20530233.excel_export.processors.{processor_name}',
