"""API controller for budget post details - sub-scheme 20530233"""
...
router = APIRouter(
    prefix="/ui/s20530233/budget-post-details",
    tags=["API - Budget Post Details 20530233"],
...
async def api_update_inline(
    ...
    current_level_count = post_level_repo.get_count(
        record.id, sub_scheme, "budget_post_details_20530233", fiscal_year
    )
