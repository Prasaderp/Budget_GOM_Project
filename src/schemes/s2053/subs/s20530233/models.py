"""Database models for sub-scheme 20530233 - District Administration (Charged)."""
...
class BudgetPostDetails20530233(BudgetDetailsMixin, Base):
    __tablename__ = "budget_post_details_20530233"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'designation',
                         name='uq_bpd_20530233_natural_key'),
        CheckConstraint('sanctioned_posts_2024_25 >= 0', name='chk_bpd_20530233_posts_2024_25'),
        CheckConstraint('sanctioned_posts_2025_26 >= 0', name='chk_bpd_20530233_posts_2025_26'),
        CheckConstraint('basic_pay >= 0', name='chk_bpd_20530233_basic_pay'),
        CheckConstraint("hra_rate IN ('X', 'Y', 'Z')", name='chk_bpd_20530233_hra_rate'),
    )


class PostStatus20530233(PostStatusMixin, Base):
    __tablename__ = "post_status_20530233"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'status',
                         name='uq_ps_20530233_natural_key'),
        CheckConstraint('posts >= 0', name='chk_ps_20530233_posts'),
        CheckConstraint('salary >= 0', name='chk_ps_20530233_salary'),
    )


class PostExpenses20530233(BudgetDetailsMixin, Base):
    __tablename__ = "post_expenses_20530233"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type',
                         name='uq_pe_20530233_natural_key'),
        CheckConstraint('filled_posts >= 0', name='chk_pe_20530233_filled_posts'),
        CheckConstraint('vacant_posts >= 0', name='chk_pe_20530233_vacant_posts'),
    )


class UnitExpenditure20530233(UnitExpenditureMixin, Base):
    __tablename__ = "unit_expenditure_20530233"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'unit_account',
                         name='uq_ue_20530233_natural_key'),
    )


BudgetPostDetails = BudgetPostDetails20530233
PostStatus = PostStatus20530233
PostExpenses = PostExpenses20530233
UnitExpenditure = UnitExpenditure20530233
