"""Configuration for sub-scheme 20530233 - District Administration (Charged)"""
from src.core.base_config import BaseSchemeConfig, FormConfig

SCHEME_CODE = "2053"
SUB_SCHEME_CODE = "20530233"
...
SCHEME_CONFIG = BaseSchemeConfig(
    ...
    entry_point="/ui/s20530233/budget-post-details",
    ...
    forms={
        ...
        "post_status": FormConfig(
            name="post_status",
            table_name="post_status_20530233",
            label_mr="प्रपत्र क",
        ...
        "post_expenses": FormConfig(
            name="post_expenses",
            table_name="post_expenses_20530233",
            label_mr="प्रपत्र ब",
        ...
        "unit_expenditure": FormConfig(
            ...
            table_name="unit_expenditure_20530233",
            label_mr="प्रपत्र अ",
