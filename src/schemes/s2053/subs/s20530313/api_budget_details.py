"""API controller for budget post details - sub-scheme 20530313"""
...
router = APIRouter(
    prefix="/ui/s20530313/budget-post-details",
    tags=["API - Budget Post Details 20530313"],
...
async def api_update_inline(
    ...
    fiscal_year_req = get_fiscal_year_from_request(request, db)
    current_level_count = post_level_repo.get_count(
        record.id, sub_scheme, "budget_post_details_20530313", fiscal_year_req
    )
