...
class BudgetPostDetails20530313(BudgetDetailsMixin, Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint('sanctioned_posts_2024_25 >= 0', name='chk_bpd_20530313_posts_2024_25'),
        CheckConstraint('sanctioned_posts_2025_26 >= 0', name='chk_bpd_20530313_posts_2025_26'),
