"""Ratnagiri district processor for sub-scheme 20530313."""
from openpyxl.utils import get_column_letter

DISTRICT_ROW_RANGES = {
    "budget_post_details": (101, 119),
    "post_status": (166, 197),
    "post_expenses": (81, 95),
    "unit_expenditure": (106, 125)
}
...
def apply_district_filtering(source_sheet, sheet_key: str):
    """Filter rows for Ratnagiri district."""
...
def apply_abstract_filtering(source_sheet):
    """Filter abstract sheet for Ratnagiri."""
