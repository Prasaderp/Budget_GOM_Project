"""Raigad district processor for sub-scheme 20530313."""
from openpyxl.utils import get_column_letter

DISTRICT_ROW_RANGES = {
    "budget_post_details": (81, 99),
    "post_status": (133, 164),
    "post_expenses": (65, 79),
    "unit_expenditure": (85, 104)
}
...
def apply_district_filtering(source_sheet, sheet_key: str):
    """Filter rows for Raigad district."""
...
def apply_abstract_filtering(source_sheet):
    """Filter abstract sheet for Raigad."""
