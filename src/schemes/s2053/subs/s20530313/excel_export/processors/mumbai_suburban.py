"""Mumbai Suburban district processor for sub-scheme 20530313."""
from openpyxl.utils import get_column_letter

DISTRICT_ROW_RANGES = {
    "budget_post_details": (21, 39),
    "post_status": (34, 65),
    "post_expenses": (17, 31),
    "unit_expenditure": (22, 41)
}
...
def apply_district_filtering(source_sheet, sheet_key: str):
    """Filter rows for Mumbai Suburban district."""
...
def apply_abstract_filtering(source_sheet):
    """Filter abstract sheet for Mumbai Suburban."""
