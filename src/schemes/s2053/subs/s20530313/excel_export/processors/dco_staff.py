"""DCO Staff district processor for sub-scheme 20530313."""
from openpyxl.utils import get_column_letter

DISTRICT_ROW_RANGES = {
    "budget_post_details": (141, 159),
    "post_status": (232, 263),
    "post_expenses": (113, 127),
    "unit_expenditure": (148, 167)
}
...
def apply_abstract_filtering(source_sheet):
    """Filter abstract sheet for DCO Staff."""
