"""Sindhudurg district processor for sub-scheme 20530313."""
from openpyxl.utils import get_column_letter

DISTRICT_ROW_RANGES = {
    "budget_post_details": (121, 139),
    "post_status": (199, 230),
    "post_expenses": (97, 111),
    "unit_expenditure": (127, 146)
}
...
def apply_district_filtering(source_sheet, sheet_key: str):
    """Filter rows for Sindhudurg district."""
...
def apply_abstract_filtering(source_sheet):
    """Filter abstract sheet for Sindhudurg."""
