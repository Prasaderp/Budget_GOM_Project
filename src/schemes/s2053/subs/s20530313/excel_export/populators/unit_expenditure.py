"""Unit expenditure populator for sub-scheme 20530313.
...
def populate_unit_expenditure(
    ...
    for district, start_row in DISTRICT_START_ROWS:
        _write_district_data(ws, db, UnitExpenditure, district, start_row, fiscal_year)
...
def _write_district_data(
    ...
    """Write unit expenditure data for a single district."""
