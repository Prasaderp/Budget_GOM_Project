"""UI routes for budget post details (Form D) - sub-scheme 20530313"""
...
async def ui_list_budget_details(
    ...
    if view == "summary":
        ...
        response = templates.TemplateResponse("schemes/s2053/subs/s20530313/budget_post_details_list.html", context)
...
async def ui_edit_budget_detail_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    response = templates.TemplateResponse("schemes/s2053/subs/s20530313/budget_post_details_form.html", {
        "request": request,
        "districts": districts_for_filter,
        "categories": CATEGORIES,
        "classes": CLASSES_SHEET1_2,
        ...
        "da_rate": da_rate,
        "api_base_path": "/ui/s20530313/budget-post-details/api/post-levels",
        "pay_matrix_api_path": "/ui/s20530313/budget-post-details/api/pay-matrix",
        "sub_scheme_code": "20530313",
        "table_name": "budget_post_details_20530313"
    })
    response.headers.update(get_no_cache_headers())
    return response
...
async def ui_update_budget_detail(
    ...
    try:
        ...
        return templates.TemplateResponse("schemes/s2053/subs/s20530313/budget_post_details_form.html", {
            "request": request,
