"""Configuration for sub-scheme 20530313 - District Administration (Voted)"""
...
CLASSES_SHEET1_2 = ['Class-3', 'Class-4']
...
CLASS_3_KEY = 'Class-3'
CLASS_4_KEY = 'Class-4'
VALID_CLASS_KEYS = [CLASS_3_KEY, CLASS_4_KEY]
...
SCHEME_CONFIG = BaseSchemeConfig(
    ...
    forms={
        ...
        "post_status": FormConfig(
            name="post_status",
            table_name="post_status_20530313",
            label_mr="प्रपत्र क",
        ...
        "post_expenses": FormConfig(
            name="post_expenses",
            table_name="post_expenses_20530313",
            label_mr="प्रपत्र ब",
        ...
        "unit_expenditure": FormConfig(
            ...
            table_name="unit_expenditure_20530313",
            label_mr="प्रपत्र अ",
