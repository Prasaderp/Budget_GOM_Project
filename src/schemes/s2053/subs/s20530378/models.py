"""Database models for sub-scheme 20530378 - District Administration (Charged)."""
...
class BudgetPostDetails20530378(BudgetDetailsMixin, Base):
    __tablename__ = "budget_post_details_20530378"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'designation',
                         name='uq_bpd_20530378_natural_key'),
        CheckConstraint('sanctioned_posts_2024_25 >= 0', name='chk_bpd_20530378_posts_2024_25'),
        CheckConstraint('sanctioned_posts_2025_26 >= 0', name='chk_bpd_20530378_posts_2025_26'),
        CheckConstraint('basic_pay >= 0', name='chk_bpd_20530378_basic_pay'),
        CheckConstraint("hra_rate IN ('X', 'Y', 'Z')", name='chk_bpd_20530378_hra_rate'),
    )


class PostStatus20530378(PostStatusMixin, Base):
    __tablename__ = "post_status_20530378"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'status',
                         name='uq_ps_20530378_natural_key'),
        CheckConstraint('posts >= 0', name='chk_ps_20530378_posts'),
        CheckConstraint('salary >= 0', name='chk_ps_20530378_salary'),
    )


class PostExpenses20530378(BudgetDetailsMixin, Base):
    __tablename__ = "post_expenses_20530378"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type',
                         name='uq_pe_20530378_natural_key'),
        CheckConstraint('filled_posts >= 0', name='chk_pe_20530378_filled_posts'),
        CheckConstraint('vacant_posts >= 0', name='chk_pe_20530378_vacant_posts'),
    )


class UnitExpenditure20530378(UnitExpenditureMixin, Base):
    __tablename__ = "unit_expenditure_20530378"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'unit_account',
                         name='uq_ue_20530378_natural_key'),
    )


BudgetPostDetails = BudgetPostDetails20530378
PostStatus = PostStatus20530378
PostExpenses = PostExpenses20530378
UnitExpenditure = UnitExpenditure20530378
