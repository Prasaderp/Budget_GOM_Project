...
def populate_budget_post_details(wb: Workbook, db: Session, sub_scheme_code: Optional[str] = None, fiscal_year: Optional[str] = None):
    ...
    perm_aliases = {
        'Deputy Collector / Probationary Deputy Collector': 'Deputy Collector',
        'Tehsildar/Additional Tehsildar/Chitnis (Clerk/Secretary)/Probationary Tehsildar': 'Tehsildar/Addl. Tehsildar/Chitnis (Secretary/Clerk)',
        'Naib Tehsildar/Probationary Naib Tehsildar': 'Naib Tehsildar',
        'Head Clerk/Deputy Accountant': 'Head Clerk (Awwal Karkun)',
        'Divisional Officer': 'Clerk',
        'Clerk/Land Surveyor/Recovery Clerk': 'Clerk',
        'Law Officer (Honorarium)': 'Deputy Accountant',
        'Telephone Operator/Steno-Typist(Law Officer Asst.)': 'Peon/Naik/Havaldar/Watchman/Cleaner',
    }

    temp_aliases = {
        'Deputy Collector': 'Deputy Collector / Probationary Deputy Collector',
        'Tehsildar/Addl. Tehsildar/Chitnis (Secretary/Clerk)': 'Tehsildar/Additional Tehsildar/Chitnis (Clerk/Secretary)/Probationary Tehsildar',
