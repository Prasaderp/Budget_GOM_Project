...
from .config import SCHEME_CONFIG, CATEGORIES, CLASSES_SHEET1_2, STATUSES, CATEGORIES_MR, CLASSES_MR, STATUSES_MR
...
async def api_update_inline(request: Request, db: Session = Depends(get_db), id: int = Form(...), Posts: int = Form(0), Salary: int = Form(0), GradePay: int = Form(0), SpecialPay: int = Form(0), DearnessAllowance: int = Form(0), LocalSupplemetoryAllowance: int = Form(0), HouseRentAllowance: int = Form(0), TravelAllowance: int = Form(0), Other: int = Form(0)):
    ...
    if not check_edit_permission(auth_role, auth_level, auth_unit, db, SCHEME_CONFIG.code):
    ...
    old_values = {"posts": record.posts, "salary": record.salary, "grade_pay": record.grade_pay, "special_pay": record.special_pay, "dearness_allowance": record.dearness_allowance, "local_supplementary_allowance": record.local_supplementary_allowance, "house_rent_allowance": record.house_rent_allowance, "travel_allowance": record.travel_allowance, "other": record.other}
    ...
    new_values = {"posts": Posts, "salary": Salary, "grade_pay": GradePay, "special_pay": SpecialPay, "dearness_allowance": DearnessAllowance, "local_supplementary_allowance": LocalSupplemetoryAllowance, "house_rent_allowance": HouseRentAllowance, "travel_allowance": TravelAllowance, "other": Other}
...
def get_district_post_status_summary_data(db: Session, district: str, fiscal_year: str = '2025-26') -> Dict[str, Any]:
    try:
        ...
        METRICS_DB_KEYS = [ 'posts', 'salary', 'grade_pay', 'special_pay', 'dearness_allowance', 'local_supplementary_allowance', 'house_rent_allowance', 'travel_allowance', 'other' ]
        ...
        for row in query_results:
            category = row.category; raw_class = row.class_type; status = row.status; class_key = CLASS_MAPPING.get(raw_class)
            ...
            for class_key in VALID_CLASS_KEYS + ['एकूण']:
                ...
                if not is_total_col:
                    ...
                    for ck in VALID_CLASS_KEYS:
                        perm_filled_class_data = summary['Permanent'].get(ck, {}).get('Filled', defaultdict(int))
                        perm_vacant_class_data = summary['Permanent'].get(ck, {}).get('Vacant', defaultdict(int))
                        temp_filled_class_data = summary['Temporary'].get(ck, {}).get('Filled', defaultdict(int))
                        temp_vacant_class_data = summary['Temporary'].get(ck, {}).get('Vacant', defaultdict(int))
                        ...
                        perm_filled_data['Posts'] += perm_filled_class_data.get('Posts', 0)
                        perm_vacant_data['Posts'] += perm_vacant_class_data.get('Posts', 0)
                        temp_filled_data['Posts'] += temp_filled_class_data.get('Posts', 0)
                        temp_vacant_data['Posts'] += temp_vacant_class_data.get('Posts', 0)
                        perm_filled_data['Salary'] += perm_filled_class_data.get('Salary', 0)
                        perm_vacant_data['Salary'] += perm_vacant_class_data.get('Salary', 0)
                        temp_filled_data['Salary'] += temp_filled_class_data.get('Salary', 0)
                        temp_vacant_data['Salary'] += temp_vacant_class_data.get('Salary', 0)
                        perm_filled_data['GradePay'] += perm_filled_class_data.get('GradePay', 0)
                        perm_vacant_data['GradePay'] += perm_vacant_class_data.get('GradePay', 0)
                        temp_filled_data['GradePay'] += temp_filled_class_data.get('GradePay', 0)
                        temp_vacant_data['GradePay'] += temp_vacant_class_data.get('GradePay', 0)
                        perm_filled_data['SpecialPay'] += perm_filled_class_data.get('SpecialPay', 0)
                        perm_vacant_data['SpecialPay'] += perm_vacant_class_data.get('SpecialPay', 0)
                        temp_filled_data['SpecialPay'] += temp_filled_class_data.get('SpecialPay', 0)
                        temp_vacant_data['SpecialPay'] += temp_vacant_class_data.get('SpecialPay', 0)
                        perm_filled_data['DearnessAllowance'] += perm_filled_class_data.get('DearnessAllowance', 0)
                        perm_vacant_data['DearnessAllowance'] += perm_vacant_class_data.get('DearnessAllowance', 0)
                        temp_filled_data['DearnessAllowance'] += temp_filled_class_data.get('DearnessAllowance', 0)
                        temp_vacant_data['DearnessAllowance'] += temp_vacant_class_data.get('DearnessAllowance', 0)
                        perm_filled_data['LocalSupplemetoryAllowance'] += perm_filled_class_data.get('LocalSupplemetoryAllowance', 0)
                        perm_vacant_data['LocalSupplemetoryAllowance'] += perm_vacant_class_data.get('LocalSupplemetoryAllowance', 0)
                        temp_filled_data['LocalSupplemetoryAllowance'] += temp_filled_class_data.get('LocalSupplemetoryAllowance', 0)
                        temp_vacant_data['LocalSupplemetoryAllowance'] += temp_vacant_class_data.get('LocalSupplemetoryAllowance', 0)
                        perm_filled_data['HouseRentAllowance'] += perm_filled_class_data.get('HouseRentAllowance', 0)
                        perm_vacant_data['HouseRentAllowance'] += perm_vacant_class_data.get('HouseRentAllowance', 0)
                        temp_filled_data['HouseRentAllowance'] += temp_filled_class_data.get('HouseRentAllowance', 0)
                        temp_vacant_data['HouseRentAllowance'] += temp_vacant_class_data.get('HouseRentAllowance', 0)
                        perm_filled_data['TravelAllowance'] += perm_filled_class_data.get('TravelAllowance', 0)
                        perm_vacant_data['TravelAllowance'] += perm_vacant_class_data.get('TravelAllowance', 0)
                        temp_filled_data['TravelAllowance'] += temp_filled_class_data.get('TravelAllowance', 0)
                        temp_vacant_data['TravelAllowance'] += temp_vacant_class_data.get('TravelAllowance', 0)
                        perm_filled_data['Other'] += perm_filled_class_data.get('Other', 0)
                        perm_vacant_data['Other'] += perm_vacant_class_data.get('Other', 0)
                        temp_filled_data['Other'] += temp_filled_class_data.get('Other', 0)
                        temp_vacant_data['Other'] += temp_vacant_class_data.get('Other', 0)
                ...
                elif label == 'वेतन': metric_key_for_comp = 'वेतन'; val_perm_filled = perm_filled_data.get('Salary', 0); val_temp_filled = temp_filled_data.get('Salary', 0); val_perm_vacant = perm_vacant_data.get('Salary', 0); val_temp_vacant = temp_vacant_data.get('Salary', 0)
                elif label == 'ग्रेड पे': metric_key_for_comp = 'ग्रेड पे'; val_perm_filled = perm_filled_data.get('GradePay', 0); val_temp_filled = temp_filled_data.get('GradePay', 0); val_perm_vacant = perm_vacant_data.get('GradePay', 0); val_temp_vacant = temp_vacant_data.get('GradePay', 0)
                elif label == 'विशेष वेतन': metric_key_for_comp = 'विशेष वेतन'; val_perm_filled = perm_filled_data.get('SpecialPay', 0); val_temp_filled = temp_filled_data.get('SpecialPay', 0); val_perm_vacant = perm_vacant_data.get('SpecialPay', 0); val_temp_vacant = temp_vacant_data.get('SpecialPay', 0)
                elif label == 'एकूण वेतन': metric_key_for_comp = 'एकूण वेतन'; val_perm_filled = perm_filled_data.get('Salary', 0) + perm_filled_data.get('GradePay', 0) + perm_filled_data.get('SpecialPay', 0); val_temp_filled = temp_filled_data.get('Salary', 0) + temp_filled_data.get('GradePay', 0) + temp_filled_data.get('SpecialPay', 0); val_perm_vacant = perm_vacant_data.get('Salary', 0) + perm_vacant_data.get('GradePay', 0) + perm_vacant_data.get('SpecialPay', 0); val_temp_vacant = temp_vacant_data.get('Salary', 0) + temp_vacant_data.get('GradePay', 0) + temp_vacant_data.get('SpecialPay', 0)
                elif label == 'महा.भत्ता': metric_key_for_comp = 'महा.भत्ता'; val_perm_filled = perm_filled_data.get('DearnessAllowance', 0); val_temp_filled = temp_filled_data.get('DearnessAllowance', 0); val_perm_vacant = perm_vacant_data.get('DearnessAllowance', 0); val_temp_vacant = temp_vacant_data.get('DearnessAllowance', 0)
                elif label == 'स्था.पु.भ.': metric_key_for_comp = 'स्था.पु.भ.'; val_perm_filled = perm_filled_data.get('LocalSupplemetoryAllowance', 0); val_temp_filled = temp_filled_data.get('LocalSupplemetoryAllowance', 0); val_perm_vacant = perm_vacant_data.get('LocalSupplemetoryAllowance', 0); val_temp_vacant = temp_vacant_data.get('LocalSupplemetoryAllowance', 0)
                elif label == 'घरभाडे': metric_key_for_comp = 'घरभाडे'; val_perm_filled = perm_filled_data.get('HouseRentAllowance', 0); val_temp_filled = temp_filled_data.get('HouseRentAllowance', 0); val_perm_vacant = perm_vacant_data.get('HouseRentAllowance', 0); val_temp_vacant = temp_vacant_data.get('HouseRentAllowance', 0)
                elif label == 'प्रवास भत्ता': metric_key_for_comp = 'प्रवास भत्ता'; val_perm_filled = perm_filled_data.get('TravelAllowance', 0); val_temp_filled = temp_filled_data.get('TravelAllowance', 0); val_perm_vacant = perm_vacant_data.get('TravelAllowance', 0); val_temp_vacant = temp_vacant_data.get('TravelAllowance', 0)
                elif label == 'इतर': metric_key_for_comp = 'इतर'; val_perm_filled = perm_filled_data.get('Other', 0); val_temp_filled = temp_filled_data.get('Other', 0); val_perm_vacant = perm_vacant_data.get('Other', 0); val_temp_vacant = temp_vacant_data.get('Other', 0)
                elif label == 'एकूण खर्च': metric_key_for_comp = 'एकूण खर्च'; val_perm_filled = sum(perm_filled_data.get(k,0) for k in ['Salary','GradePay','SpecialPay','DearnessAllowance','LocalSupplemetoryAllowance','HouseRentAllowance','TravelAllowance','Other']); val_temp_filled = sum(temp_filled_data.get(k,0) for k in ['Salary','GradePay','SpecialPay','DearnessAllowance','LocalSupplemetoryAllowance','HouseRentAllowance','TravelAllowance','Other']); val_perm_vacant = sum(perm_vacant_data.get(k,0) for k in ['Salary','GradePay','SpecialPay','DearnessAllowance','LocalSupplemetoryAllowance','HouseRentAllowance','TravelAllowance','Other']); val_temp_vacant = sum(temp_vacant_data.get(k,0) for k in ['Salary','GradePay','SpecialPay','DearnessAllowance','LocalSupplemetoryAllowance','HouseRentAllowance','TravelAllowance','Other'])
        ...
        for cat in ['Permanent', 'Temporary']:
            ...
            for cls_key in VALID_CLASS_KEYS:
                ...
                class_cat_total_amt = sum(filled_data.get(k,0) for k in ['Salary','GradePay','SpecialPay','DearnessAllowance','LocalSupplemetoryAllowance','HouseRentAllowance','TravelAllowance','Other'])
        ...
        return {
            ...
            'final_class_summary_table': final_class_summary, 'raw_summary_dict': summary,
        ...
        logger.error(f"(Helper REVISED) Error fetching/processing district post status summary data for {district}: {e}", exc_info=True)
        return None

@ttl_cache(ttl_seconds=180, use_global=True)
def get_post_status_summary_data(db: Session, fiscal_year: str = '2025-26') -> Dict[str, Any]:
    try:
        CLASS_1_2_KEY = 'वर्ग-1 व 2'
        CLASS_3_KEY = 'वर्ग-3'
        CLASS_4_KEY = 'वर्ग-4'
...
async def ui_list_post_status(
    ...
    context = {
        ...
        "districts_mr": DISTRICTS_MR, "categories_mr": CATEGORIES_MR, "classes_mr": CLASSES_MR, "statuses_mr": STATUSES_MR,
    ...
    if view == "summary":
        ...
        if auth_level == 'district' and auth_unit:
            ...
            district_name = get_district_from_taluka(auth_unit)
            summary_data = get_district_post_status_summary_data(db, district_name, fiscal_year) if district_name else None
        else:
        ...
        try:
            ...
            if labels:
                ...
                chart_data['district_allowance_breakdown'] = {'labels': labels, 'Salary': dist_salary, 'GradePay': dist_grade, 'SpecialPay': dist_special, 'Allowances': dist_allowances}
...
async def ui_update_post_status( request: Request, id: int, db: Session = Depends(get_db), District: str = Form(...), Category: str = Form(...), Class: str = Form(...), Status: str = Form(...), Posts: Optional[int] = Form(None), Salary: Optional[int] = Form(None), GradePay: Optional[int] = Form(None), SpecialPay: Optional[int] = Form(None), DearnessAllowance: Optional[int] = Form(None), LocalSupplemetoryAllowance: Optional[int] = Form(None), HouseRentAllowance: Optional[int] = Form(None), TravelAllowance: Optional[int] = Form(None), Other: Optional[int] = Form(None) ):
    ...
    try:
        update_dict = {
            "district": District, "category": Category, "class_type": Class, "status": Status, "posts": Posts,
            "salary": Salary, "grade_pay": GradePay, "special_pay": SpecialPay,
        ...
        if auth_level == 'district' and auth_unit:
            districts_for_filter = [auth_unit]
        return templates.TemplateResponse("schemes/s2053/subs/s20530028/post_status_form.html", { "request": request, "error": f"रेकॉर्ड अपडेट करण्यात अयशस्वी: {e}", "districts": districts_for_filter, "categories": CATEGORIES, "classes": CLASSES_SHEET1_2, "statuses": STATUSES, "item": db_item, "resource_name": "प्रपत्र क संपादन", "districts_mr": DISTRICTS_MR, "categories_mr": CATEGORIES_MR, "classes_mr": CLASSES_MR, "statuses_mr": STATUSES_MR, "auth_level": auth_level }, status_code=400)
...
async def export_post_status_original(request: Request, db: Session = Depends(get_db), district: Optional[str] = Query(None)):
    auth_level = request.cookies.get('auth_level')
    auth_unit = request.cookies.get('auth_unit')
    user_district = None
...
async def export_post_status_sheet_only(request: Request, db: Session = Depends(get_db), district: Optional[str] = Query(None)):
    auth_level = request.cookies.get('auth_level')
    auth_unit = request.cookies.get('auth_unit')
    user_district = None
    if auth_level == 'district':
        ...
        user_district = district
    return export_original_workbook(db, only_sheet="post_status", user_district=user_district)