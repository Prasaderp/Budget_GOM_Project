"""UI routes for budget post details (Form D) - sub-scheme 20530304"""
...
async def ui_edit_budget_detail_form(request: Request, id: int, db: Session = Depends(get_db)):
    ...
    response = render(request, "schemes/s2053/subs/s20530304/budget_post_details_form.html", {
        ...
        "da_rate": da_rate,
        "api_base_path": "/ui/s20530304/budget-post-details/api/post-levels",
        "pay_matrix_api_path": "/ui/s20530304/budget-post-details/api/pay-matrix",
        "sub_scheme_code": SUB_SCHEME_CODE,
        "table_name": "budget_post_details_20530304",
        "relative_years": relative_years
    })
    response.headers.update(get_no_cache_headers())
    return response
    ...
    try:
        if SanctionedPostsCurr is not None:
            ...
            current_level_count = post_level_repo.get_count(
                id, sub_scheme, "budget_post_details_20530304", db_detail.fiscal_year
            )
        ...
        return render(request, "schemes/s2053/subs/s20530304/budget_post_details_form.html", {
            ...
            "designations_mr": DESIGNATIONS_MR,
            "auth_level": auth_level,
            "da_rate": get_da_rate(db, error_fiscal_year),
