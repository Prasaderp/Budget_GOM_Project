"""Database models for sub-scheme 20530387 - District Administration (Voted)."""
...
class BudgetPostDetails20530387(BudgetDetailsMixin, Base):
    __tablename__ = "budget_post_details_20530387"
    ...
    __table_args__ = (
        ...
        CheckConstraint('sanctioned_posts_2024_25 >= 0', name='chk_bpd_20530387_posts_2024_25'),
        CheckConstraint('sanctioned_posts_2025_26 >= 0', name='chk_bpd_20530387_posts_2025_26'),
        CheckConstraint('basic_pay >= 0', name='chk_bpd_20530387_basic_pay'),
        CheckConstraint("hra_rate IN ('X', 'Y', 'Z')", name='chk_bpd_20530387_hra_rate'),
    )


class PostStatus20530387(PostStatusMixin, Base):
    __tablename__ = "post_status_20530387"
...
class PostExpenses20530387(BudgetDetailsMixin, Base):
    __tablename__ = "post_expenses_20530387"
...
class UnitExpenditure20530387(UnitExpenditureMixin, Base):
    __tablename__ = "unit_expenditure_20530387"
...
BudgetPostDetails = BudgetPostDetails20530387
PostStatus = PostStatus20530387
PostExpenses = PostExpenses20530387
UnitExpenditure = UnitExpenditure20530387
