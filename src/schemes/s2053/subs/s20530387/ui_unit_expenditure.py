...
async def export_unit_expenditure_summary_excel(request: Request, db: Session = Depends(get_db)):
    ...
    headers_map = {
        ...
        "expenditure_prev4": f"प्रत्यक्ष रक्कमा {relative_years['prev4']}",
        "expenditure_prev3": f"प्रत्यक्ष रक्कमा {relative_years['prev3']}",
        "expenditure_prev2": f"प्रत्यक्ष रक्कमा {relative_years['prev2']}",
        "budget_prev1": f"अर्थसंकल्पीय अंदाज {relative_years['prev1']}",
        "forecast_prev1": f"सुधारीत अंदाज {relative_years['prev1']}",
        "budget_curr_estimating_officer": f"अर्थसंकल्पीय {relative_years['curr']} प्राकक्लन",
        "budget_curr_controlling_officer": f"अर्थसंकल्पीय {relative_years['curr']} नियंत्रक",
        "budget_curr_admin_dept": f"अर्थसंकल्पीय {relative_years['curr']} प्रशासकीय",
        "budget_curr_finance_dept": f"अर्थसंकल्पीय {relative_years['curr']} वित्त",
    }
