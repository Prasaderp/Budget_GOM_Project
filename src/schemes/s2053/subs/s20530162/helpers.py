"""Shared helper utilities for sub-scheme 20530162"""
...
_audit_executor = ThreadPoolExecutor(max_workers=2, thread_name_prefix="audit_s20530162")

MAX_INPUT_VALUE = 999999999

def check_edit_permission_for_scheme(auth_role: str, auth_level: str, auth_unit: str, db: Session) -> bool:
    """Unified permission check for scheme 20530162"""
