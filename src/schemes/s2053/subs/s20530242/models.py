"""Database models for sub-scheme 20530242 - District Administration (Voted)."""
...
class BudgetPostDetails20530242(BudgetDetailsMixin, Base):
    __tablename__ = "budget_post_details_20530242"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'designation',
                         name='uq_bpd_20530242_natural_key'),
        CheckConstraint('sanctioned_posts_2024_25 >= 0', name='chk_bpd_20530242_posts_2024_25'),
        CheckConstraint('sanctioned_posts_2025_26 >= 0', name='chk_bpd_20530242_posts_2025_26'),
        CheckConstraint('basic_pay >= 0', name='chk_bpd_20530242_basic_pay'),
        CheckConstraint("hra_rate IN ('X', 'Y', 'Z')", name='chk_bpd_20530242_hra_rate'),
    )


class PostStatus20530242(PostStatusMixin, Base):
    __tablename__ = "post_status_20530242"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'status',
                         name='uq_ps_20530242_natural_key'),
        CheckConstraint('posts >= 0', name='chk_ps_20530242_posts'),
        CheckConstraint('salary >= 0', name='chk_ps_20530242_salary'),
    )


class PostExpenses20530242(BudgetDetailsMixin, Base):
    __tablename__ = "post_expenses_20530242"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type',
                         name='uq_pe_20530242_natural_key'),
        CheckConstraint('filled_posts >= 0', name='chk_pe_20530242_filled_posts'),
        CheckConstraint('vacant_posts >= 0', name='chk_pe_20530242_vacant_posts'),
    )


class UnitExpenditure20530242(UnitExpenditureMixin, Base):
    __tablename__ = "unit_expenditure_20530242"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'unit_account',
                         name='uq_ue_20530242_natural_key'),
    )


BudgetPostDetails = BudgetPostDetails20530242
PostStatus = PostStatus20530242
PostExpenses = PostExpenses20530242
UnitExpenditure = UnitExpenditure20530242
