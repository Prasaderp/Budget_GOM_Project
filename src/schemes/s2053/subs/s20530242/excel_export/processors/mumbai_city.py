"""Mumbai City district processor for sub-scheme 20530242."""
from openpyxl.utils import get_column_letter

# Row ranges for district filtering (20530242 has simpler structure)
DISTRICT_ROW_RANGES = {
    "budget_post_details": (1, 17),
    "post_status": (1, 32),
    "post_expenses": (1, 16),
