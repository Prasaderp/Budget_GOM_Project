"""Palghar district processor for sub-scheme 20530242."""
from openpyxl.utils import get_column_letter

DISTRICT_ROW_RANGES = {
    "budget_post_details": (64, 71),
    "post_status": (100, 131),
    "post_expenses": (49, 63),
    "unit_expenditure": (67, 87)
}
...
def apply_district_filtering(source_sheet, sheet_key: str):
    """Filter rows for Palghar district."""
...
def apply_abstract_filtering(source_sheet):
    """Filter abstract sheet for Palghar."""
