"""Thane district processor for sub-scheme 20530242."""
from openpyxl.utils import get_column_letter

DISTRICT_ROW_RANGES = {
    "budget_post_details": (37, 43),
    "post_status": (62, 98),
    "post_expenses": (33, 47),
    "unit_expenditure": (45, 65)
}
...
def apply_district_filtering(source_sheet, sheet_key: str):
    """Filter rows for Thane district."""
...
def apply_abstract_filtering(source_sheet):
    """Filter abstract sheet for Thane."""
