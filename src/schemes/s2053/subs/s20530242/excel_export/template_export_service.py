"""Template-based Excel export service for sub-scheme 20530242.
        ...
        for ext in (".xlsx", ".xls"):
            for pattern in (f"Budget {sub_scheme_code} for 2026-27{ext}",
                ...
                if os.path.exists(path):
                    return path
    return "excel_templates/s2053/subs/s20530242/Budget 20530242 for 2026-27.xlsx"
...
def _get_processor_module(district: str):
    ...
    try:
        return __import__(
            f'src.schemes.s2053.subs.s20530242.excel_export.processors.{processor_name}',
