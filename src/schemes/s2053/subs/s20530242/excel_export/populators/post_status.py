"""Post status populator for sub-scheme 20530242.

20530242 has single designation in Class-3, so only Class-3 column
is populated. Simplified row mappings compared to 20530162.
"""
