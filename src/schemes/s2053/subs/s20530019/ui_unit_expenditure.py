"""UI routes for unit expenditure (Form A) - sub-scheme 20530019"""
...
router = APIRouter(prefix="/ui/s20530019/unit-expenditure", tags=["UI - प्रपत्र अ"], include_in_schema=False)
