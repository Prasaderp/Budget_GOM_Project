"""UI routes for post status (Form C) - sub-scheme 20530019"""
...
router = APIRouter(
    prefix="/ui/s20530019/post-status",
    tags=["UI - प्रपत्र क"],
...
async def ui_list_post_status(
    ...
    if view == "summary":
        ...
        response = templates.TemplateResponse("schemes/s2053/subs/s20530019/post_status_list.html", context)
