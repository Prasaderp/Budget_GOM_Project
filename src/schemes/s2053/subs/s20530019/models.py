"""Database models for sub-scheme 20530019 - District Administration (Charged)."""
...
class BudgetPostDetails20530019(BudgetDetailsMixin, Base):
    __tablename__ = "budget_post_details_20530019"
...
class PostStatus20530019(PostStatusMixin, Base):
    __tablename__ = "post_status_20530019"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'status', 'taluka',
                         name='uq_ps_20530019_natural_key'),
        CheckConstraint('posts >= 0', name='chk_ps_20530019_posts'),
        CheckConstraint('salary >= 0', name='chk_ps_20530019_salary'),
    )


class PostExpenses20530019(BudgetDetailsMixin, Base):
    __tablename__ = "post_expenses_20530019"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'taluka',
                         name='uq_pe_20530019_natural_key'),
        CheckConstraint('filled_posts >= 0', name='chk_pe_20530019_filled_posts'),
        CheckConstraint('vacant_posts >= 0', name='chk_pe_20530019_vacant_posts'),
    )


class UnitExpenditure20530019(UnitExpenditureMixin, Base):
    __tablename__ = "unit_expenditure_20530019"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'unit_account', 'taluka',
                         name='uq_ue_20530019_natural_key'),
    )


BudgetPostDetails = BudgetPostDetails20530019
PostStatus = PostStatus20530019
PostExpenses = PostExpenses20530019
UnitExpenditure = UnitExpenditure20530019
