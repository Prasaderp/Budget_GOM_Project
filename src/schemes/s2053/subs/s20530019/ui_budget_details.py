...
from src.utils_auth import get_auth_unit, get_auth_level, get_auth_role
...
async def ui_list_budget_details(
    ...
    if view == "summary":
        ...
        response = templates.TemplateResponse("schemes/s2053/subs/s20530019/budget_post_details_list.html", context)
