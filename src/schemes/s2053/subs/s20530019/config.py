"""Configuration for sub-scheme 20530019 - District Administration (Charged)"""
...
SCHEME_CONFIG = BaseSchemeConfig(
    ...
    entry_point="/ui/s20530019/budget-post-details",
    ...
    forms={
        ...
        "post_status": FormConfig(
            name="post_status",
            table_name="post_status_20530019",
            label_mr="प्रपत्र क",
        ...
        "post_expenses": FormConfig(
            name="post_expenses",
            table_name="post_expenses_20530019",
            label_mr="प्रपत्र ब",
        ...
        "unit_expenditure": FormConfig(
            ...
            table_name="unit_expenditure_20530019",
            label_mr="प्रपत्र अ",
