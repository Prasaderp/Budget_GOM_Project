...
router = APIRouter(
    prefix="/ui/s20530019/budget-summary",
...
def _process_budget_query_results(query_results, internal_col_keys, prev1_label: str, curr_label: str, da_rate: float, include_dearness: bool = True, include_hra: bool = True):
