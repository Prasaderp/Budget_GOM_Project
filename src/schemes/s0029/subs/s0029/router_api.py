...
def create_district_revenue(
    ...
    existing = (
        ...
        .filter(
            ...
            DistrictRevenue0029.taluka == DISTRICT_OFFICE,
        )
        .first()
    )
    if existing:
    ...
    item = create_row_family(db, DistrictRevenue0029, payload, request)
    db.commit()
    db.refresh(item)
...
def delete_district_revenue(
    ...
    delete_row_family(db, DistrictRevenue0029, id, request)
    db.commit()
