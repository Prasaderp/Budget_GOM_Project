...
def populate_unit_expenditure(wb: Workbook, db: Session, sub_scheme_code: Optional[str] = None, fiscal_year: Optional[str] = None):
    ...
    write_district("Mumbai Suburban", 29)
    write_district("Thane", 51)
    write_district("Palghar", 73)
    write_district("Raigad", 95)
    write_district("Ratnagiri", 117)
    write_district("Sindhudurg", 139)
    write_district("DCO Staff", 161)