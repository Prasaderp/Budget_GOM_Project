"""Template-based Excel export service for sub-scheme 20450091.
...
def _get_template_path(sub_scheme_code: Optional[str] = None) -> str:
    ...
    # Default fallback
    return "excel_templates/s2045/subs/s20450091/Budget 20450091 for 2026-27.xlsx"
...
def _get_processor_module(district: str):
    ...
    try:
        processor_module = __import__(
            f'src.schemes.s2045.subs.s20450091.excel_export.processors.{processor_name}',
