"""Database models for sub-scheme 20450091 - Stamp Duty Collection (Voted)."""
...
class BudgetPostDetails20450091(BudgetDetailsMixin, Base):
    __tablename__ = "budget_post_details_20450091"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'designation',
                         name='uq_bpd_20450091_natural_key'),
        CheckConstraint('sanctioned_posts_2024_25 >= 0', name='chk_bpd_20450091_posts_2024_25'),
        CheckConstraint('sanctioned_posts_2025_26 >= 0', name='chk_bpd_20450091_posts_2025_26'),
        CheckConstraint('basic_pay >= 0', name='chk_bpd_20450091_basic_pay'),
        CheckConstraint("hra_rate IN ('X', 'Y', 'Z')", name='chk_bpd_20450091_hra_rate'),
    )


class PostStatus20450091(PostStatusMixin, Base):
    __tablename__ = "post_status_20450091"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type', 'status',
                         name='uq_ps_20450091_natural_key'),
        CheckConstraint('posts >= 0', name='chk_ps_20450091_posts'),
        CheckConstraint('salary >= 0', name='chk_ps_20450091_salary'),
    )


class PostExpenses20450091(BudgetDetailsMixin, Base):
    __tablename__ = "post_expenses_20450091"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'category', 'class_type',
                         name='uq_pe_20450091_natural_key'),
        CheckConstraint('filled_posts >= 0', name='chk_pe_20450091_filled_posts'),
        CheckConstraint('vacant_posts >= 0', name='chk_pe_20450091_vacant_posts'),
    )


class UnitExpenditure20450091(UnitExpenditureMixin, Base):
    __tablename__ = "unit_expenditure_20450091"
    ...
    __table_args__ = (
        UniqueConstraint('fiscal_year', 'district', 'unit_account',
                         name='uq_ue_20450091_natural_key'),
    )


BudgetPostDetails = BudgetPostDetails20450091
PostStatus = PostStatus20450091
PostExpenses = PostExpenses20450091
UnitExpenditure = UnitExpenditure20450091
