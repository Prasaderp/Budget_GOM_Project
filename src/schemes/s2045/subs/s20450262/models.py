"""Database models for sub-scheme 20450262."""
...
DistrictExpenditure20450262 = create_district_expenditure_model(
    table_name=TABLE_NAME,
    scheme_code=SCHEME_CODE,
    sub_scheme_code=SUB_SCHEME_CODE,
)

__all__ = ['DistrictExpenditure20450262', 'SCHEME_CODE', 'SUB_SCHEME_CODE', 'TABLE_NAME']
