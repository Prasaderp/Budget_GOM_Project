"""Routers for sub-scheme 20450182."""
...
from .models import DistrictExpenditure20450182
...
ui_router, api_router = create_district_expenditure_routers(
    ...
    model_class=DistrictExpenditure20450182,
    helper=helper,
    template_base_path="schemes/s2045/subs/s20450182",
    resource_name_mr="20450182 जिल्हानिहाय खर्च",
