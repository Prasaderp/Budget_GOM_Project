"""Template-based Excel export service for sub-scheme 2215.
...
TEMPLATE_DIR = "excel_templates/s2215/subs/s2215"
...
def export_original_workbook(
    ...
    return ExcelExportService.create_response(
        content=output,
        base_filename="2215_water_scarcity",
        fiscal_year=fiscal_year,
    )
